...
hero_image:
  src: '/assets/articles/texas-severance-tax-what-owners-need-to-know.webp'
  alt: 'A royalty statement, tax worksheet, calculator, and Texas-shaped paperweight with pumpjacks in the background.'
  width: 1200
  height: 630
