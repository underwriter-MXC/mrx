...
internal_links:
  ...
  conversion: '/book/'
hero_image:
  src: '/assets/articles/how-horizontal-drilling-changed-mineral-rights-values-in-texas.webp'
  alt: 'How Horizontal Drilling Changed Mineral Rights Values in Texas educational illustration'
  width: 1600
  height: 900
  mime_type: 'image/webp'
  social_src: '/assets/articles/share/how-horizontal-drilling-changed-mineral-rights-values-in-texas-share.jpg'
  social_alt: 'Two abstract well-path geometries side by side, a short vertical line and a long lateral line, in MRX navy on cream.'
  social_width: 1200
  social_height: 630
