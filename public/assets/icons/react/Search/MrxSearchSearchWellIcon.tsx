...
export interface MrxSearchSearchWellIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxSearchSearchWellIcon({ title = 'Search Well', ...props }: MrxSearchSearchWellIconProps) {
  return (
...
export default MrxSearchSearchWellIcon;
