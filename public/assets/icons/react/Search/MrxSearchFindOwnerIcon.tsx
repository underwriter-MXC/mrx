...
export interface MrxSearchFindOwnerIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxSearchFindOwnerIcon({ title = 'Find Owner', ...props }: MrxSearchFindOwnerIconProps) {
  return (
...
export default MrxSearchFindOwnerIcon;
