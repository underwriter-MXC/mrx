...
export interface MrxSearchSortIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxSearchSortIcon({ title = 'Sort', ...props }: MrxSearchSortIconProps) {
  return (
...
export default MrxSearchSortIcon;
