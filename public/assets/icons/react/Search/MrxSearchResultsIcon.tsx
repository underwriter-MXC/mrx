...
export interface MrxSearchResultsIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxSearchResultsIcon({ title = 'Results', ...props }: MrxSearchResultsIconProps) {
  return (
...
export default MrxSearchResultsIcon;
