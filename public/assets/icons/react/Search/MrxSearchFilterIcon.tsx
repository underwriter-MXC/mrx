...
export interface MrxSearchFilterIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxSearchFilterIcon({ title = 'Filter', ...props }: MrxSearchFilterIconProps) {
  return (
  ...
  <path d="M21 28h14M28 21v14" fill="none" stroke="#C8A24A" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"/>
  <path d="M14 57h36" fill="none" stroke="#C8A24A" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  );
}

export default MrxSearchFilterIcon;
