...
export interface MrxSearchSearchParcelIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxSearchSearchParcelIcon({ title = 'Search Parcel', ...props }: MrxSearchSearchParcelIconProps) {
  return (
...
export default MrxSearchSearchParcelIcon;
