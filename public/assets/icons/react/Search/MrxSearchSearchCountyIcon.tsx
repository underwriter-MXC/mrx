...
export interface MrxSearchSearchCountyIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxSearchSearchCountyIcon({ title = 'Search County', ...props }: MrxSearchSearchCountyIconProps) {
  return (
...
export default MrxSearchSearchCountyIcon;
