...
export interface MrxSearchVerifiedResultsIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxSearchVerifiedResultsIcon({ title = 'Verified Results', ...props }: MrxSearchVerifiedResultsIconProps) {
  return (
...
export default MrxSearchVerifiedResultsIcon;
