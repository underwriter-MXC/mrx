...
export interface MrxSearchLookupIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxSearchLookupIcon({ title = 'Lookup', ...props }: MrxSearchLookupIconProps) {
  return (
...
export default MrxSearchLookupIcon;
