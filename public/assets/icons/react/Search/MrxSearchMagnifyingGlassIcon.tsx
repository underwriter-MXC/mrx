...
export interface MrxSearchMagnifyingGlassIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxSearchMagnifyingGlassIcon({ title = 'Magnifying Glass', ...props }: MrxSearchMagnifyingGlassIconProps) {
  return (
...
export default MrxSearchMagnifyingGlassIcon;
