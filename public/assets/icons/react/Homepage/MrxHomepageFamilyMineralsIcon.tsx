...
export interface MrxHomepageFamilyMineralsIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxHomepageFamilyMineralsIcon({ title = 'Family Minerals', ...props }: MrxHomepageFamilyMineralsIconProps) {
  return (
...
export default MrxHomepageFamilyMineralsIcon;
