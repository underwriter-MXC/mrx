...
export interface MrxHomepageCashOffersIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxHomepageCashOffersIcon({ title = 'Cash Offers', ...props }: MrxHomepageCashOffersIconProps) {
  return (
...
export default MrxHomepageCashOffersIcon;
