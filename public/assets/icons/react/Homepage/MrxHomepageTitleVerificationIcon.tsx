...
export interface MrxHomepageTitleVerificationIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxHomepageTitleVerificationIcon({ title = 'Title Verification', ...props }: MrxHomepageTitleVerificationIconProps) {
  return (
...
export default MrxHomepageTitleVerificationIcon;
