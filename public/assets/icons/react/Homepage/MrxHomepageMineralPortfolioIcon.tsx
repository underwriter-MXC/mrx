...
export interface MrxHomepageMineralPortfolioIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxHomepageMineralPortfolioIcon({ title = 'Mineral Portfolio', ...props }: MrxHomepageMineralPortfolioIconProps) {
  return (
...
export default MrxHomepageMineralPortfolioIcon;
