...
export interface MrxHomepageOfferComparisonIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxHomepageOfferComparisonIcon({ title = 'Offer Comparison', ...props }: MrxHomepageOfferComparisonIconProps) {
  return (
...
export default MrxHomepageOfferComparisonIcon;
