...
export interface MrxHomepageDrillingActivityIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxHomepageDrillingActivityIcon({ title = 'Drilling Activity', ...props }: MrxHomepageDrillingActivityIconProps) {
  return (
...
export default MrxHomepageDrillingActivityIcon;
