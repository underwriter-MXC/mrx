...
export interface MrxHomepageOwnershipResearchIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxHomepageOwnershipResearchIcon({ title = 'Ownership Research', ...props }: MrxHomepageOwnershipResearchIconProps) {
  return (
...
export default MrxHomepageOwnershipResearchIcon;
