...
export interface MrxHomepageInheritedMineralsIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxHomepageInheritedMineralsIcon({ title = 'Inherited Minerals', ...props }: MrxHomepageInheritedMineralsIconProps) {
  return (
...
export default MrxHomepageInheritedMineralsIcon;
