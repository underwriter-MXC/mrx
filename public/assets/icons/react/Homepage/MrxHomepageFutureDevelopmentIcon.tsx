...
export interface MrxHomepageFutureDevelopmentIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxHomepageFutureDevelopmentIcon({ title = 'Future Development', ...props }: MrxHomepageFutureDevelopmentIconProps) {
  return (
...
export default MrxHomepageFutureDevelopmentIcon;
