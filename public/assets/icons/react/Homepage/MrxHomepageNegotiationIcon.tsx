...
export interface MrxHomepageNegotiationIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxHomepageNegotiationIcon({ title = 'Negotiation', ...props }: MrxHomepageNegotiationIconProps) {
  return (
...
export default MrxHomepageNegotiationIcon;
