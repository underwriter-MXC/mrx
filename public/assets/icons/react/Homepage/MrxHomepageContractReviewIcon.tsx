...
export interface MrxHomepageContractReviewIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxHomepageContractReviewIcon({ title = 'Contract Review', ...props }: MrxHomepageContractReviewIconProps) {
  return (
...
export default MrxHomepageContractReviewIcon;
