...
export interface MrxHomepageRoyaltyAnalysisIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxHomepageRoyaltyAnalysisIcon({ title = 'Royalty Analysis', ...props }: MrxHomepageRoyaltyAnalysisIconProps) {
  return (
...
export default MrxHomepageRoyaltyAnalysisIcon;
