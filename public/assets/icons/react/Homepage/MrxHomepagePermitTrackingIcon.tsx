...
export interface MrxHomepagePermitTrackingIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxHomepagePermitTrackingIcon({ title = 'Permit Tracking', ...props }: MrxHomepagePermitTrackingIconProps) {
  return (
...
export default MrxHomepagePermitTrackingIcon;
