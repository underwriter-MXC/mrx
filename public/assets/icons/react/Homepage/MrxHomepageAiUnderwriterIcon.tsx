...
export interface MrxHomepageAiUnderwriterIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxHomepageAiUnderwriterIcon({ title = 'AI Underwriter', ...props }: MrxHomepageAiUnderwriterIconProps) {
  return (
...
export default MrxHomepageAiUnderwriterIcon;
