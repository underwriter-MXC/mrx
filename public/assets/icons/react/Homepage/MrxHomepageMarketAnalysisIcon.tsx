...
export interface MrxHomepageMarketAnalysisIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxHomepageMarketAnalysisIcon({ title = 'Market Analysis', ...props }: MrxHomepageMarketAnalysisIconProps) {
  return (
...
export default MrxHomepageMarketAnalysisIcon;
