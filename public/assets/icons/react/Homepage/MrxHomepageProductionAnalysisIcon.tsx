...
export interface MrxHomepageProductionAnalysisIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxHomepageProductionAnalysisIcon({ title = 'Production Analysis', ...props }: MrxHomepageProductionAnalysisIconProps) {
  return (
...
export default MrxHomepageProductionAnalysisIcon;
