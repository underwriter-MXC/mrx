...
export interface MrxHomepageMineralValuationIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxHomepageMineralValuationIcon({ title = 'Mineral Valuation', ...props }: MrxHomepageMineralValuationIconProps) {
  return (
...
export default MrxHomepageMineralValuationIcon;
