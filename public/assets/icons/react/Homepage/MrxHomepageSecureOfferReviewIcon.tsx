...
export interface MrxHomepageSecureOfferReviewIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxHomepageSecureOfferReviewIcon({ title = 'Secure Offer Review', ...props }: MrxHomepageSecureOfferReviewIconProps) {
  return (
...
export default MrxHomepageSecureOfferReviewIcon;
