...
export interface MrxHomepageCountyResearchIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxHomepageCountyResearchIcon({ title = 'County Research', ...props }: MrxHomepageCountyResearchIconProps) {
  return (
...
export default MrxHomepageCountyResearchIcon;
