...
export interface MrxHomepageProductionForecastIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxHomepageProductionForecastIcon({ title = 'Production Forecast', ...props }: MrxHomepageProductionForecastIconProps) {
  return (
...
export default MrxHomepageProductionForecastIcon;
