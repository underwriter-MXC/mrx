...
export interface MrxOwnershipLandRecordsIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxOwnershipLandRecordsIcon({ title = 'Land Records', ...props }: MrxOwnershipLandRecordsIconProps) {
  return (
...
export default MrxOwnershipLandRecordsIcon;
