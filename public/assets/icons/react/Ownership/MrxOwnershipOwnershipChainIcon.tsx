...
export interface MrxOwnershipOwnershipChainIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxOwnershipOwnershipChainIcon({ title = 'Ownership Chain', ...props }: MrxOwnershipOwnershipChainIconProps) {
  return (
...
export default MrxOwnershipOwnershipChainIcon;
