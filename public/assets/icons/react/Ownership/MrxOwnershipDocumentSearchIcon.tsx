...
export interface MrxOwnershipDocumentSearchIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxOwnershipDocumentSearchIcon({ title = 'Document Search', ...props }: MrxOwnershipDocumentSearchIconProps) {
  return (
...
export default MrxOwnershipDocumentSearchIcon;
