...
export interface MrxOwnershipOwnerIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxOwnershipOwnerIcon({ title = 'Owner', ...props }: MrxOwnershipOwnerIconProps) {
  return (
...
export default MrxOwnershipOwnerIcon;
