...
export interface MrxOwnershipCountyCourthouseIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxOwnershipCountyCourthouseIcon({ title = 'County Courthouse', ...props }: MrxOwnershipCountyCourthouseIconProps) {
  return (
...
export default MrxOwnershipCountyCourthouseIcon;
