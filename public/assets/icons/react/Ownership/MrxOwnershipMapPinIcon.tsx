...
export interface MrxOwnershipMapPinIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxOwnershipMapPinIcon({ title = 'Map Pin', ...props }: MrxOwnershipMapPinIconProps) {
  return (
...
export default MrxOwnershipMapPinIcon;
