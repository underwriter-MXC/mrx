...
export interface MrxOwnershipMineralDeedIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxOwnershipMineralDeedIcon({ title = 'Mineral Deed', ...props }: MrxOwnershipMineralDeedIconProps) {
  return (
...
export default MrxOwnershipMineralDeedIcon;
