...
export interface MrxOwnershipPropertyRecordsIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxOwnershipPropertyRecordsIcon({ title = 'Property Records', ...props }: MrxOwnershipPropertyRecordsIconProps) {
  return (
...
export default MrxOwnershipPropertyRecordsIcon;
