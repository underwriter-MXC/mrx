...
export interface MrxOwnershipTitleSearchIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxOwnershipTitleSearchIcon({ title = 'Title Search', ...props }: MrxOwnershipTitleSearchIconProps) {
  return (
...
export default MrxOwnershipTitleSearchIcon;
