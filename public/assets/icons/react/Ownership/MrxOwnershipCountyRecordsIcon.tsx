...
export interface MrxOwnershipCountyRecordsIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxOwnershipCountyRecordsIcon({ title = 'County Records', ...props }: MrxOwnershipCountyRecordsIconProps) {
  return (
...
export default MrxOwnershipCountyRecordsIcon;
