...
export interface MrxOwnershipSurveyMarkerIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxOwnershipSurveyMarkerIcon({ title = 'Survey Marker', ...props }: MrxOwnershipSurveyMarkerIconProps) {
  return (
...
export default MrxOwnershipSurveyMarkerIcon;
