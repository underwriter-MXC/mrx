...
export interface MrxOwnershipPropertyBoundaryIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxOwnershipPropertyBoundaryIcon({ title = 'Property Boundary', ...props }: MrxOwnershipPropertyBoundaryIconProps) {
  return (
...
export default MrxOwnershipPropertyBoundaryIcon;
