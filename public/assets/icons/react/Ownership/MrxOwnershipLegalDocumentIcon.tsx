...
export interface MrxOwnershipLegalDocumentIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxOwnershipLegalDocumentIcon({ title = 'Legal Document', ...props }: MrxOwnershipLegalDocumentIconProps) {
  return (
...
export default MrxOwnershipLegalDocumentIcon;
