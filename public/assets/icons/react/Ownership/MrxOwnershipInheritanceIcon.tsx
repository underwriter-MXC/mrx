...
export interface MrxOwnershipInheritanceIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxOwnershipInheritanceIcon({ title = 'Inheritance', ...props }: MrxOwnershipInheritanceIconProps) {
  return (
...
export default MrxOwnershipInheritanceIcon;
