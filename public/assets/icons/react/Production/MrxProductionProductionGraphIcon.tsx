...
export interface MrxProductionProductionGraphIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxProductionProductionGraphIcon({ title = 'Production Graph', ...props }: MrxProductionProductionGraphIconProps) {
  return (
...
export default MrxProductionProductionGraphIcon;
