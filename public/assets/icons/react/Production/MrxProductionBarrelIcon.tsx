...
export interface MrxProductionBarrelIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxProductionBarrelIcon({ title = 'Barrel', ...props }: MrxProductionBarrelIconProps) {
  return (
...
export default MrxProductionBarrelIcon;
