...
export interface MrxProductionStorageTankIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxProductionStorageTankIcon({ title = 'Storage Tank', ...props }: MrxProductionStorageTankIconProps) {
  return (
...
export default MrxProductionStorageTankIcon;
