...
export interface MrxProductionFlowMeterIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxProductionFlowMeterIcon({ title = 'Flow Meter', ...props }: MrxProductionFlowMeterIconProps) {
  return (
...
export default MrxProductionFlowMeterIcon;
