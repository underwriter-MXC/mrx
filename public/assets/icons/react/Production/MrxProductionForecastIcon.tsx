...
export interface MrxProductionForecastIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxProductionForecastIcon({ title = 'Forecast', ...props }: MrxProductionForecastIconProps) {
  return (
...
export default MrxProductionForecastIcon;
