...
export interface MrxProductionPipelineIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxProductionPipelineIcon({ title = 'Pipeline', ...props }: MrxProductionPipelineIconProps) {
  return (
...
export default MrxProductionPipelineIcon;
