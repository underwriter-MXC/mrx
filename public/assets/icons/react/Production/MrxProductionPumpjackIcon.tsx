...
export interface MrxProductionPumpjackIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxProductionPumpjackIcon({ title = 'Pumpjack', ...props }: MrxProductionPumpjackIconProps) {
  return (
...
export default MrxProductionPumpjackIcon;
