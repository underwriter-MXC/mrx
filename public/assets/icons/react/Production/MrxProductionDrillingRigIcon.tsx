...
export interface MrxProductionDrillingRigIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxProductionDrillingRigIcon({ title = 'Drilling Rig', ...props }: MrxProductionDrillingRigIconProps) {
  return (
...
export default MrxProductionDrillingRigIcon;
