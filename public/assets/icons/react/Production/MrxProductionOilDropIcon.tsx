...
export interface MrxProductionOilDropIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxProductionOilDropIcon({ title = 'Oil Drop', ...props }: MrxProductionOilDropIconProps) {
  return (
...
export default MrxProductionOilDropIcon;
