...
export interface MrxProductionMonthlyProductionIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxProductionMonthlyProductionIcon({ title = 'Monthly Production', ...props }: MrxProductionMonthlyProductionIconProps) {
  return (
...
export default MrxProductionMonthlyProductionIcon;
