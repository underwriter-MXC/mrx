...
export interface MrxProductionRefineryIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxProductionRefineryIcon({ title = 'Refinery', ...props }: MrxProductionRefineryIconProps) {
  return (
...
export default MrxProductionRefineryIcon;
