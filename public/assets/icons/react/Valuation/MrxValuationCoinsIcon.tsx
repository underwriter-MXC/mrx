...
export interface MrxValuationCoinsIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxValuationCoinsIcon({ title = 'Coins', ...props }: MrxValuationCoinsIconProps) {
  return (
...
export default MrxValuationCoinsIcon;
