...
export interface MrxValuationTrendDownIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxValuationTrendDownIcon({ title = 'Trend Down', ...props }: MrxValuationTrendDownIconProps) {
  return (
...
export default MrxValuationTrendDownIcon;
