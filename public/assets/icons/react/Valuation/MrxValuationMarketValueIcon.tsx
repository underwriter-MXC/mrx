...
export interface MrxValuationMarketValueIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxValuationMarketValueIcon({ title = 'Market Value', ...props }: MrxValuationMarketValueIconProps) {
  return (
...
export default MrxValuationMarketValueIcon;
