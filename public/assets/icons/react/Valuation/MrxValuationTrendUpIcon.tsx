...
export interface MrxValuationTrendUpIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxValuationTrendUpIcon({ title = 'Trend Up', ...props }: MrxValuationTrendUpIconProps) {
  return (
...
export default MrxValuationTrendUpIcon;
