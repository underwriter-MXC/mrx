...
export interface MrxValuationOfferIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxValuationOfferIcon({ title = 'Offer', ...props }: MrxValuationOfferIconProps) {
  return (
...
export default MrxValuationOfferIcon;
