...
export interface MrxValuationCalculatorIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxValuationCalculatorIcon({ title = 'Calculator', ...props }: MrxValuationCalculatorIconProps) {
  return (
...
export default MrxValuationCalculatorIcon;
