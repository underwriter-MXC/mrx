...
export interface MrxValuationPriceTagIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxValuationPriceTagIcon({ title = 'Price Tag', ...props }: MrxValuationPriceTagIconProps) {
  return (
...
export default MrxValuationPriceTagIcon;
