...
export interface MrxValuationDollarIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxValuationDollarIcon({ title = 'Dollar', ...props }: MrxValuationDollarIconProps) {
  return (
...
export default MrxValuationDollarIcon;
