...
export interface MrxValuationStackOfCashIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxValuationStackOfCashIcon({ title = 'Stack of Cash', ...props }: MrxValuationStackOfCashIconProps) {
  return (
...
export default MrxValuationStackOfCashIcon;
