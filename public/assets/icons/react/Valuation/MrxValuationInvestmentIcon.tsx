...
export interface MrxValuationInvestmentIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxValuationInvestmentIcon({ title = 'Investment', ...props }: MrxValuationInvestmentIconProps) {
  return (
...
export default MrxValuationInvestmentIcon;
