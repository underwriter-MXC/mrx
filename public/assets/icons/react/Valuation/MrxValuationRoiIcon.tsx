...
export interface MrxValuationRoiIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxValuationRoiIcon({ title = 'ROI', ...props }: MrxValuationRoiIconProps) {
  return (
...
export default MrxValuationRoiIcon;
