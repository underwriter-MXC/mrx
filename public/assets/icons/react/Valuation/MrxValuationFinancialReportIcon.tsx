...
export interface MrxValuationFinancialReportIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxValuationFinancialReportIcon({ title = 'Financial Report', ...props }: MrxValuationFinancialReportIconProps) {
  return (
...
export default MrxValuationFinancialReportIcon;
