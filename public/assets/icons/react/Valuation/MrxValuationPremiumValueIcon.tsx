...
export interface MrxValuationPremiumValueIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxValuationPremiumValueIcon({ title = 'Premium Value', ...props }: MrxValuationPremiumValueIconProps) {
  return (
...
export default MrxValuationPremiumValueIcon;
