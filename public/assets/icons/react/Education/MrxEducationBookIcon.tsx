...
export interface MrxEducationBookIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxEducationBookIcon({ title = 'Book', ...props }: MrxEducationBookIconProps) {
  return (
...
export default MrxEducationBookIcon;
