...
export interface MrxEducationKnowledgeIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxEducationKnowledgeIcon({ title = 'Knowledge', ...props }: MrxEducationKnowledgeIconProps) {
  return (
...
export default MrxEducationKnowledgeIcon;
