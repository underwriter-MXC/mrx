...
export interface MrxEducationLearningIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxEducationLearningIcon({ title = 'Learning', ...props }: MrxEducationLearningIconProps) {
  return (
...
export default MrxEducationLearningIcon;
