...
export interface MrxEducationLightbulbIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxEducationLightbulbIcon({ title = 'Lightbulb', ...props }: MrxEducationLightbulbIconProps) {
  return (
...
export default MrxEducationLightbulbIcon;
