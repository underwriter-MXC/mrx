...
export interface MrxEducationChecklistIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxEducationChecklistIcon({ title = 'Checklist', ...props }: MrxEducationChecklistIconProps) {
  return (
...
export default MrxEducationChecklistIcon;
