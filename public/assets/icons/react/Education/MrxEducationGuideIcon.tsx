...
export interface MrxEducationGuideIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxEducationGuideIcon({ title = 'Guide', ...props }: MrxEducationGuideIconProps) {
  return (
...
export default MrxEducationGuideIcon;
