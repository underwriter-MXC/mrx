...
export interface MrxEducationQuestionIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxEducationQuestionIcon({ title = 'Question', ...props }: MrxEducationQuestionIconProps) {
  return (
...
export default MrxEducationQuestionIcon;
