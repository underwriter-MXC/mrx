...
export interface MrxEducationArticleIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxEducationArticleIcon({ title = 'Article', ...props }: MrxEducationArticleIconProps) {
  return (
...
export default MrxEducationArticleIcon;
