...
export interface MrxEducationVideoIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxEducationVideoIcon({ title = 'Video', ...props }: MrxEducationVideoIconProps) {
  return (
...
export default MrxEducationVideoIcon;
