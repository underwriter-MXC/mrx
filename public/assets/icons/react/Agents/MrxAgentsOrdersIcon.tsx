...
export interface MrxAgentsOrdersIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxAgentsOrdersIcon({ title = 'Orders', ...props }: MrxAgentsOrdersIconProps) {
  return (
...
export default MrxAgentsOrdersIcon;
