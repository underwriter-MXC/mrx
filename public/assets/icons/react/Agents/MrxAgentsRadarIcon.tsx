...
export interface MrxAgentsRadarIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxAgentsRadarIcon({ title = 'Radar', ...props }: MrxAgentsRadarIconProps) {
  return (
...
export default MrxAgentsRadarIcon;
