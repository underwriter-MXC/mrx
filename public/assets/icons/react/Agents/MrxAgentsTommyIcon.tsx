...
export interface MrxAgentsTommyIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxAgentsTommyIcon({ title = 'Tommy', ...props }: MrxAgentsTommyIconProps) {
  return (
...
export default MrxAgentsTommyIcon;
