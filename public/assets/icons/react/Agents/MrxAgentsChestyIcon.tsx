...
export interface MrxAgentsChestyIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxAgentsChestyIcon({ title = 'Chesty', ...props }: MrxAgentsChestyIconProps) {
  return (
...
export default MrxAgentsChestyIcon;
