...
export interface MrxAgentsReedIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxAgentsReedIcon({ title = 'Reed', ...props }: MrxAgentsReedIconProps) {
  return (
...
export default MrxAgentsReedIcon;
