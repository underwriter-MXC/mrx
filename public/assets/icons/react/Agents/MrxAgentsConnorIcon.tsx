...
export interface MrxAgentsConnorIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxAgentsConnorIcon({ title = 'Connor', ...props }: MrxAgentsConnorIconProps) {
  return (
...
export default MrxAgentsConnorIcon;
