...
export interface MrxAgentsMasonIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxAgentsMasonIcon({ title = 'Mason', ...props }: MrxAgentsMasonIconProps) {
  return (
...
export default MrxAgentsMasonIcon;
