...
export interface MrxAgentsMissionFailedIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxAgentsMissionFailedIcon({ title = 'Mission Failed', ...props }: MrxAgentsMissionFailedIconProps) {
  return (
  ...
  <text x="32" y="29" textAnchor="middle" fontFamily="Arial, sans-serif" fontSize="8" fontWeight="700" fill="#0B1F3A">MF</text>
  <path d="M14 57h36" fill="none" stroke="#C8A24A" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  );
}

export default MrxAgentsMissionFailedIcon;
