...
export interface MrxAgentsLaurelIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxAgentsLaurelIcon({ title = 'Laurel', ...props }: MrxAgentsLaurelIconProps) {
  return (
...
export default MrxAgentsLaurelIcon;
