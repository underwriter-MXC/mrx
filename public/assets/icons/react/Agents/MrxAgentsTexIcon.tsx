...
export interface MrxAgentsTexIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxAgentsTexIcon({ title = 'Tex', ...props }: MrxAgentsTexIconProps) {
  return (
...
export default MrxAgentsTexIcon;
