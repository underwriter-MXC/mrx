...
export interface MrxLegalSecureIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxLegalSecureIcon({ title = 'Secure', ...props }: MrxLegalSecureIconProps) {
  return (
...
export default MrxLegalSecureIcon;
