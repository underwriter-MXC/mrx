...
export interface MrxLegalComplianceIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxLegalComplianceIcon({ title = 'Compliance', ...props }: MrxLegalComplianceIconProps) {
  return (
...
export default MrxLegalComplianceIcon;
