...
export interface MrxLegalLockIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxLegalLockIcon({ title = 'Lock', ...props }: MrxLegalLockIconProps) {
  return (
...
export default MrxLegalLockIcon;
