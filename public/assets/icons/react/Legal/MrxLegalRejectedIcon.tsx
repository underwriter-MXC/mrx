...
export interface MrxLegalRejectedIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxLegalRejectedIcon({ title = 'Rejected', ...props }: MrxLegalRejectedIconProps) {
  return (
...
export default MrxLegalRejectedIcon;
