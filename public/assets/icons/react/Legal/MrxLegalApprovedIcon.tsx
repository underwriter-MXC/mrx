...
export interface MrxLegalApprovedIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxLegalApprovedIcon({ title = 'Approved', ...props }: MrxLegalApprovedIconProps) {
  return (
...
export default MrxLegalApprovedIcon;
