...
export interface MrxLegalCertificateIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxLegalCertificateIcon({ title = 'Certificate', ...props }: MrxLegalCertificateIconProps) {
  return (
...
export default MrxLegalCertificateIcon;
