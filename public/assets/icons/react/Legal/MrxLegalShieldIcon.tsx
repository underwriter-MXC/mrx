...
export interface MrxLegalShieldIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxLegalShieldIcon({ title = 'Shield', ...props }: MrxLegalShieldIconProps) {
  return (
...
export default MrxLegalShieldIcon;
