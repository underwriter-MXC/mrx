...
export interface MrxLegalLegalDocumentIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxLegalLegalDocumentIcon({ title = 'Legal Document', ...props }: MrxLegalLegalDocumentIconProps) {
  return (
...
export default MrxLegalLegalDocumentIcon;
