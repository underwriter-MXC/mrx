...
export interface MrxLegalPrivacyIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxLegalPrivacyIcon({ title = 'Privacy', ...props }: MrxLegalPrivacyIconProps) {
  return (
...
export default MrxLegalPrivacyIcon;
