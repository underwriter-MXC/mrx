...
export interface MrxLegalScaleOfJusticeIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxLegalScaleOfJusticeIcon({ title = 'Scale of Justice', ...props }: MrxLegalScaleOfJusticeIconProps) {
  return (
...
export default MrxLegalScaleOfJusticeIcon;
