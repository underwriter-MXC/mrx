...
export interface MrxLegalAttorneyIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxLegalAttorneyIcon({ title = 'Attorney', ...props }: MrxLegalAttorneyIconProps) {
  return (
...
export default MrxLegalAttorneyIcon;
