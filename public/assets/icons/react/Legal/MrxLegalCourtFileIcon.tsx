...
export interface MrxLegalCourtFileIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxLegalCourtFileIcon({ title = 'Court File', ...props }: MrxLegalCourtFileIconProps) {
  return (
...
export default MrxLegalCourtFileIcon;
