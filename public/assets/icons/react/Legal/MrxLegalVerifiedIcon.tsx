...
export interface MrxLegalVerifiedIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxLegalVerifiedIcon({ title = 'Verified', ...props }: MrxLegalVerifiedIconProps) {
  return (
...
export default MrxLegalVerifiedIcon;
