...
export interface MrxLegalAuditIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxLegalAuditIcon({ title = 'Audit', ...props }: MrxLegalAuditIconProps) {
  return (
...
export default MrxLegalAuditIcon;
