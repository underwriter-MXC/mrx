...
export interface MrxGeologyRockLayersIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxGeologyRockLayersIcon({ title = 'Rock Layers', ...props }: MrxGeologyRockLayersIconProps) {
  return (
...
export default MrxGeologyRockLayersIcon;
