...
export interface MrxGeologyEarthIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxGeologyEarthIcon({ title = 'Earth', ...props }: MrxGeologyEarthIconProps) {
  return (
...
export default MrxGeologyEarthIcon;
