...
export interface MrxGeologyMountainIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxGeologyMountainIcon({ title = 'Mountain', ...props }: MrxGeologyMountainIconProps) {
  return (
...
export default MrxGeologyMountainIcon;
