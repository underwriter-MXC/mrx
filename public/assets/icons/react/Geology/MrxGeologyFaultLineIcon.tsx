...
export interface MrxGeologyFaultLineIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxGeologyFaultLineIcon({ title = 'Fault Line', ...props }: MrxGeologyFaultLineIconProps) {
  return (
...
export default MrxGeologyFaultLineIcon;
