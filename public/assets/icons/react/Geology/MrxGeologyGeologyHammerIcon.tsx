...
export interface MrxGeologyGeologyHammerIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxGeologyGeologyHammerIcon({ title = 'Geology Hammer', ...props }: MrxGeologyGeologyHammerIconProps) {
  return (
...
export default MrxGeologyGeologyHammerIcon;
