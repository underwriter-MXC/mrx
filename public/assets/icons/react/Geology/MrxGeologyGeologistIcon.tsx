...
export interface MrxGeologyGeologistIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxGeologyGeologistIcon({ title = 'Geologist', ...props }: MrxGeologyGeologistIconProps) {
  return (
...
export default MrxGeologyGeologistIcon;
