...
export interface MrxGeologyCoreSampleIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxGeologyCoreSampleIcon({ title = 'Core Sample', ...props }: MrxGeologyCoreSampleIconProps) {
  return (
...
export default MrxGeologyCoreSampleIcon;
