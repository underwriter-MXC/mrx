...
export interface MrxGeologyUndergroundLayersIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxGeologyUndergroundLayersIcon({ title = 'Underground Layers', ...props }: MrxGeologyUndergroundLayersIconProps) {
  return (
...
export default MrxGeologyUndergroundLayersIcon;
