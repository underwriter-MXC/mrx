...
export interface MrxGeologyFormationIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxGeologyFormationIcon({ title = 'Formation', ...props }: MrxGeologyFormationIconProps) {
  return (
...
export default MrxGeologyFormationIcon;
