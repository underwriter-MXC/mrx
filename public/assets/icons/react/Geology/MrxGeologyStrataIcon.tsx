...
export interface MrxGeologyStrataIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxGeologyStrataIcon({ title = 'Strata', ...props }: MrxGeologyStrataIconProps) {
  return (
...
export default MrxGeologyStrataIcon;
