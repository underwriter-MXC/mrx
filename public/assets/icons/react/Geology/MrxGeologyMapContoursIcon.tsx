...
export interface MrxGeologyMapContoursIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxGeologyMapContoursIcon({ title = 'Map Contours', ...props }: MrxGeologyMapContoursIconProps) {
  return (
...
export default MrxGeologyMapContoursIcon;
