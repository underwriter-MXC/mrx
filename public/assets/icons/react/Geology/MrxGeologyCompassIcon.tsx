...
export interface MrxGeologyCompassIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxGeologyCompassIcon({ title = 'Compass', ...props }: MrxGeologyCompassIconProps) {
  return (
...
export default MrxGeologyCompassIcon;
