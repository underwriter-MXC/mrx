...
export interface MrxGeologyCrossSectionIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxGeologyCrossSectionIcon({ title = 'Cross Section', ...props }: MrxGeologyCrossSectionIconProps) {
  return (
...
export default MrxGeologyCrossSectionIcon;
