...
export interface MrxMarketingAnalyticsIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxMarketingAnalyticsIcon({ title = 'Analytics', ...props }: MrxMarketingAnalyticsIconProps) {
  return (
...
export default MrxMarketingAnalyticsIcon;
