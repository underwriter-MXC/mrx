...
export interface MrxMarketingGoogleIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxMarketingGoogleIcon({ title = 'Google', ...props }: MrxMarketingGoogleIconProps) {
  return (
...
export default MrxMarketingGoogleIcon;
