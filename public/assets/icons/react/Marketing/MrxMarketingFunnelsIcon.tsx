...
export interface MrxMarketingFunnelsIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxMarketingFunnelsIcon({ title = 'Funnels', ...props }: MrxMarketingFunnelsIconProps) {
  return (
...
export default MrxMarketingFunnelsIcon;
