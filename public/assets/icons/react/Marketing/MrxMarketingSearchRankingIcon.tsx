...
export interface MrxMarketingSearchRankingIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxMarketingSearchRankingIcon({ title = 'Search Ranking', ...props }: MrxMarketingSearchRankingIconProps) {
  return (
...
export default MrxMarketingSearchRankingIcon;
