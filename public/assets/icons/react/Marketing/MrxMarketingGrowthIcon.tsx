...
export interface MrxMarketingGrowthIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxMarketingGrowthIcon({ title = 'Growth', ...props }: MrxMarketingGrowthIconProps) {
  return (
...
export default MrxMarketingGrowthIcon;
