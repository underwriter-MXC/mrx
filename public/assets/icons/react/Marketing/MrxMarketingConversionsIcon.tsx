...
export interface MrxMarketingConversionsIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxMarketingConversionsIcon({ title = 'Conversions', ...props }: MrxMarketingConversionsIconProps) {
  return (
...
export default MrxMarketingConversionsIcon;
