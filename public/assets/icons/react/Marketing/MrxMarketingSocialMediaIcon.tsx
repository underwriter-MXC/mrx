...
export interface MrxMarketingSocialMediaIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxMarketingSocialMediaIcon({ title = 'Social Media', ...props }: MrxMarketingSocialMediaIconProps) {
  return (
...
export default MrxMarketingSocialMediaIcon;
