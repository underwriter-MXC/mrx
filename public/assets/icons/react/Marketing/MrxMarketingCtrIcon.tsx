...
export interface MrxMarketingCtrIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxMarketingCtrIcon({ title = 'CTR', ...props }: MrxMarketingCtrIconProps) {
  return (
...
export default MrxMarketingCtrIcon;
