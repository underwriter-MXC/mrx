...
export interface MrxMarketingVisitorsIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxMarketingVisitorsIcon({ title = 'Visitors', ...props }: MrxMarketingVisitorsIconProps) {
  return (
...
export default MrxMarketingVisitorsIcon;
