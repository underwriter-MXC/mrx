...
export interface MrxMarketingSeoIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxMarketingSeoIcon({ title = 'SEO', ...props }: MrxMarketingSeoIconProps) {
  return (
...
export default MrxMarketingSeoIcon;
