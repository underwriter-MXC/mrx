...
export interface MrxMarketingTrafficIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxMarketingTrafficIcon({ title = 'Traffic', ...props }: MrxMarketingTrafficIconProps) {
  return (
...
export default MrxMarketingTrafficIcon;
