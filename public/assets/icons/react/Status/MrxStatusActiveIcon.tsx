...
export interface MrxStatusActiveIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxStatusActiveIcon({ title = 'Active', ...props }: MrxStatusActiveIconProps) {
  return (
...
export default MrxStatusActiveIcon;
