...
export interface MrxStatusScheduledIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxStatusScheduledIcon({ title = 'Scheduled', ...props }: MrxStatusScheduledIconProps) {
  return (
...
export default MrxStatusScheduledIcon;
