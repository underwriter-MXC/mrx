...
export interface MrxStatusOnlineIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxStatusOnlineIcon({ title = 'Online', ...props }: MrxStatusOnlineIconProps) {
  return (
...
export default MrxStatusOnlineIcon;
