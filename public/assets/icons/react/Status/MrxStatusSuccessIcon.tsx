...
export interface MrxStatusSuccessIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxStatusSuccessIcon({ title = 'Success', ...props }: MrxStatusSuccessIconProps) {
  return (
...
export default MrxStatusSuccessIcon;
