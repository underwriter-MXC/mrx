...
export interface MrxStatusLoadingIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxStatusLoadingIcon({ title = 'Loading', ...props }: MrxStatusLoadingIconProps) {
  return (
...
export default MrxStatusLoadingIcon;
