...
export interface MrxStatusInactiveIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxStatusInactiveIcon({ title = 'Inactive', ...props }: MrxStatusInactiveIconProps) {
  return (
...
export default MrxStatusInactiveIcon;
