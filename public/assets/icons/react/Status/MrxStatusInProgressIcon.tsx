...
export interface MrxStatusInProgressIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxStatusInProgressIcon({ title = 'In Progress', ...props }: MrxStatusInProgressIconProps) {
  return (
...
export default MrxStatusInProgressIcon;
