...
export interface MrxStatusCompletedIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxStatusCompletedIcon({ title = 'Completed', ...props }: MrxStatusCompletedIconProps) {
  return (
...
export default MrxStatusCompletedIcon;
