...
export interface MrxStatusSyncIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxStatusSyncIcon({ title = 'Sync', ...props }: MrxStatusSyncIconProps) {
  return (
...
export default MrxStatusSyncIcon;
