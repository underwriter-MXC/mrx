...
export interface MrxStatusInfoIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxStatusInfoIcon({ title = 'Info', ...props }: MrxStatusInfoIconProps) {
  return (
...
export default MrxStatusInfoIcon;
