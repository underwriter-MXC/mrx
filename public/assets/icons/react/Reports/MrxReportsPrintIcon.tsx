...
export interface MrxReportsPrintIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxReportsPrintIcon({ title = 'Print', ...props }: MrxReportsPrintIconProps) {
  return (
...
export default MrxReportsPrintIcon;
