...
export interface MrxReportsLineGraphIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxReportsLineGraphIcon({ title = 'Line Graph', ...props }: MrxReportsLineGraphIconProps) {
  return (
...
export default MrxReportsLineGraphIcon;
