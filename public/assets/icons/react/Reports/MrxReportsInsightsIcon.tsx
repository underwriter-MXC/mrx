...
export interface MrxReportsInsightsIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxReportsInsightsIcon({ title = 'Insights', ...props }: MrxReportsInsightsIconProps) {
  return (
...
export default MrxReportsInsightsIcon;
