...
export interface MrxReportsAnalyticsIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxReportsAnalyticsIcon({ title = 'Analytics', ...props }: MrxReportsAnalyticsIconProps) {
  return (
...
export default MrxReportsAnalyticsIcon;
