...
export interface MrxReportsUploadIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxReportsUploadIcon({ title = 'Upload', ...props }: MrxReportsUploadIconProps) {
  return (
...
export default MrxReportsUploadIcon;
