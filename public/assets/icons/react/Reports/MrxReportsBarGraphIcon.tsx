...
export interface MrxReportsBarGraphIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxReportsBarGraphIcon({ title = 'Bar Graph', ...props }: MrxReportsBarGraphIconProps) {
  return (
...
export default MrxReportsBarGraphIcon;
