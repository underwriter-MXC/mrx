...
export interface MrxReportsDownloadIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxReportsDownloadIcon({ title = 'Download', ...props }: MrxReportsDownloadIconProps) {
  return (
...
export default MrxReportsDownloadIcon;
