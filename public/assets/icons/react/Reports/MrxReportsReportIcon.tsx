...
export interface MrxReportsReportIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxReportsReportIcon({ title = 'Report', ...props }: MrxReportsReportIconProps) {
  return (
...
export default MrxReportsReportIcon;
