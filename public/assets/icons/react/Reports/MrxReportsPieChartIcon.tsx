...
export interface MrxReportsPieChartIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxReportsPieChartIcon({ title = 'Pie Chart', ...props }: MrxReportsPieChartIconProps) {
  return (
...
export default MrxReportsPieChartIcon;
