...
export interface MrxReportsDashboardIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxReportsDashboardIcon({ title = 'Dashboard', ...props }: MrxReportsDashboardIconProps) {
  return (
...
export default MrxReportsDashboardIcon;
