...
export interface MrxReportsSummaryIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxReportsSummaryIcon({ title = 'Summary', ...props }: MrxReportsSummaryIconProps) {
  return (
...
export default MrxReportsSummaryIcon;
