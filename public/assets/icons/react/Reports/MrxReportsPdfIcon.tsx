...
export interface MrxReportsPdfIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxReportsPdfIcon({ title = 'PDF', ...props }: MrxReportsPdfIconProps) {
  return (
...
export default MrxReportsPdfIcon;
