...
export interface MrxReportsClipboardIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxReportsClipboardIcon({ title = 'Clipboard', ...props }: MrxReportsClipboardIconProps) {
  return (
...
export default MrxReportsClipboardIcon;
