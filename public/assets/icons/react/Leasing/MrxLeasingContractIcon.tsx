...
export interface MrxLeasingContractIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxLeasingContractIcon({ title = 'Contract', ...props }: MrxLeasingContractIconProps) {
  return (
...
export default MrxLeasingContractIcon;
