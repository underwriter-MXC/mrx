...
export interface MrxLeasingRoyaltyIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxLeasingRoyaltyIcon({ title = 'Royalty', ...props }: MrxLeasingRoyaltyIconProps) {
  return (
...
export default MrxLeasingRoyaltyIcon;
