...
export interface MrxLeasingNegotiationIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxLeasingNegotiationIcon({ title = 'Negotiation', ...props }: MrxLeasingNegotiationIconProps) {
  return (
...
export default MrxLeasingNegotiationIcon;
