...
export interface MrxLeasingExpirationIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxLeasingExpirationIcon({ title = 'Expiration', ...props }: MrxLeasingExpirationIconProps) {
  return (
...
export default MrxLeasingExpirationIcon;
