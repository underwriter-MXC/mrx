...
export interface MrxLeasingLeaseIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxLeasingLeaseIcon({ title = 'Lease', ...props }: MrxLeasingLeaseIconProps) {
  return (
...
export default MrxLeasingLeaseIcon;
