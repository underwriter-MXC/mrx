...
export interface MrxLeasingRenewalIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxLeasingRenewalIcon({ title = 'Renewal', ...props }: MrxLeasingRenewalIconProps) {
  return (
...
export default MrxLeasingRenewalIcon;
