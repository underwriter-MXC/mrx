...
export interface MrxLeasingSignatureIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxLeasingSignatureIcon({ title = 'Signature', ...props }: MrxLeasingSignatureIconProps) {
  return (
...
export default MrxLeasingSignatureIcon;
