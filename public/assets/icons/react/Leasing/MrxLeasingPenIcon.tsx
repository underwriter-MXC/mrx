...
export interface MrxLeasingPenIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxLeasingPenIcon({ title = 'Pen', ...props }: MrxLeasingPenIconProps) {
  return (
...
export default MrxLeasingPenIcon;
