...
export interface MrxLeasingHandshakeIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxLeasingHandshakeIcon({ title = 'Handshake', ...props }: MrxLeasingHandshakeIconProps) {
  return (
...
export default MrxLeasingHandshakeIcon;
