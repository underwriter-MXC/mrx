...
export interface MrxLeasingLeasePaymentIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxLeasingLeasePaymentIcon({ title = 'Lease Payment', ...props }: MrxLeasingLeasePaymentIconProps) {
  return (
...
export default MrxLeasingLeasePaymentIcon;
