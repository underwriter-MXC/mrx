...
export interface MrxLeasingAgreementIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxLeasingAgreementIcon({ title = 'Agreement', ...props }: MrxLeasingAgreementIconProps) {
  return (
...
export default MrxLeasingAgreementIcon;
