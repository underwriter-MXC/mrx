...
export interface MrxNavigationProfileIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxNavigationProfileIcon({ title = 'Profile', ...props }: MrxNavigationProfileIconProps) {
  return (
...
export default MrxNavigationProfileIcon;
