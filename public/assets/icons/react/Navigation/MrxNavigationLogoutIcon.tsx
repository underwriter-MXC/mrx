...
export interface MrxNavigationLogoutIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxNavigationLogoutIcon({ title = 'Logout', ...props }: MrxNavigationLogoutIconProps) {
  return (
...
export default MrxNavigationLogoutIcon;
