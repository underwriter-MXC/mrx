...
export interface MrxNavigationArticlesIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxNavigationArticlesIcon({ title = 'Articles', ...props }: MrxNavigationArticlesIconProps) {
  return (
...
export default MrxNavigationArticlesIcon;
