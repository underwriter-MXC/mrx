...
export interface MrxNavigationSettingsIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxNavigationSettingsIcon({ title = 'Settings', ...props }: MrxNavigationSettingsIconProps) {
  return (
...
export default MrxNavigationSettingsIcon;
