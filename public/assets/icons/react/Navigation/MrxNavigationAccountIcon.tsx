...
export interface MrxNavigationAccountIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxNavigationAccountIcon({ title = 'Account', ...props }: MrxNavigationAccountIconProps) {
  return (
...
export default MrxNavigationAccountIcon;
