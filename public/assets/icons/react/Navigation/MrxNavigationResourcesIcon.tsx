...
export interface MrxNavigationResourcesIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxNavigationResourcesIcon({ title = 'Resources', ...props }: MrxNavigationResourcesIconProps) {
  return (
...
export default MrxNavigationResourcesIcon;
