...
export interface MrxNavigationPricingIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxNavigationPricingIcon({ title = 'Pricing', ...props }: MrxNavigationPricingIconProps) {
  return (
...
export default MrxNavigationPricingIcon;
