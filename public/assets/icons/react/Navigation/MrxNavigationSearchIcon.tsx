...
export interface MrxNavigationSearchIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxNavigationSearchIcon({ title = 'Search', ...props }: MrxNavigationSearchIconProps) {
  return (
...
export default MrxNavigationSearchIcon;
