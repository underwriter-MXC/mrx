...
export interface MrxNavigationNotificationsIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxNavigationNotificationsIcon({ title = 'Notifications', ...props }: MrxNavigationNotificationsIconProps) {
  return (
...
export default MrxNavigationNotificationsIcon;
