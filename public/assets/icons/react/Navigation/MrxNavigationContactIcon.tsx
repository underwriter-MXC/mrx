...
export interface MrxNavigationContactIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxNavigationContactIcon({ title = 'Contact', ...props }: MrxNavigationContactIconProps) {
  return (
...
export default MrxNavigationContactIcon;
