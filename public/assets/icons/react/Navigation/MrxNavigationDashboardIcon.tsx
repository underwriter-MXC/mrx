...
export interface MrxNavigationDashboardIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxNavigationDashboardIcon({ title = 'Dashboard', ...props }: MrxNavigationDashboardIconProps) {
  return (
...
export default MrxNavigationDashboardIcon;
