...
export interface MrxNavigationEducationIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxNavigationEducationIcon({ title = 'Education', ...props }: MrxNavigationEducationIconProps) {
  return (
...
export default MrxNavigationEducationIcon;
