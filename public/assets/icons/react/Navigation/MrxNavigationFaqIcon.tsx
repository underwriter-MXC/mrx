...
export interface MrxNavigationFaqIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxNavigationFaqIcon({ title = 'FAQ', ...props }: MrxNavigationFaqIconProps) {
  return (
...
export default MrxNavigationFaqIcon;
