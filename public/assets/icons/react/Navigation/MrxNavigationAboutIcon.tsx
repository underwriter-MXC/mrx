...
export interface MrxNavigationAboutIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxNavigationAboutIcon({ title = 'About', ...props }: MrxNavigationAboutIconProps) {
  return (
...
export default MrxNavigationAboutIcon;
