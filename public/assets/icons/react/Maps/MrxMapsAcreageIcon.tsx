...
export interface MrxMapsAcreageIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxMapsAcreageIcon({ title = 'Acreage', ...props }: MrxMapsAcreageIconProps) {
  return (
...
export default MrxMapsAcreageIcon;
