...
export interface MrxMapsRadiusIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxMapsRadiusIcon({ title = 'Radius', ...props }: MrxMapsRadiusIconProps) {
  return (
...
export default MrxMapsRadiusIcon;
