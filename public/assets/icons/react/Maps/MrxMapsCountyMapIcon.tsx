...
export interface MrxMapsCountyMapIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxMapsCountyMapIcon({ title = 'County Map', ...props }: MrxMapsCountyMapIconProps) {
  return (
...
export default MrxMapsCountyMapIcon;
