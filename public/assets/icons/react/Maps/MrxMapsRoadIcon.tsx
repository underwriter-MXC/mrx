...
export interface MrxMapsRoadIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxMapsRoadIcon({ title = 'Road', ...props }: MrxMapsRoadIconProps) {
  return (
...
export default MrxMapsRoadIcon;
