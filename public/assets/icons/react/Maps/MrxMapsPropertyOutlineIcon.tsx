...
export interface MrxMapsPropertyOutlineIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxMapsPropertyOutlineIcon({ title = 'Property Outline', ...props }: MrxMapsPropertyOutlineIconProps) {
  return (
...
export default MrxMapsPropertyOutlineIcon;
