...
export interface MrxMapsGpsIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxMapsGpsIcon({ title = 'GPS', ...props }: MrxMapsGpsIconProps) {
  return (
