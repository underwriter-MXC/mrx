...
export interface MrxMapsNearbyWellsIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxMapsNearbyWellsIcon({ title = 'Nearby Wells', ...props }: MrxMapsNearbyWellsIconProps) {
  return (
...
export default MrxMapsNearbyWellsIcon;
