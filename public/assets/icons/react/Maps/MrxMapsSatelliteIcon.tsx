...
export interface MrxMapsSatelliteIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxMapsSatelliteIcon({ title = 'Satellite', ...props }: MrxMapsSatelliteIconProps) {
  return (
...
export default MrxMapsSatelliteIcon;
