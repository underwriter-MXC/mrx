...
export interface MrxMapsSurveyIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxMapsSurveyIcon({ title = 'Survey', ...props }: MrxMapsSurveyIconProps) {
  return (
...
export default MrxMapsSurveyIcon;
