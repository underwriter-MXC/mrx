...
export interface MrxMapsNavigationIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxMapsNavigationIcon({ title = 'Navigation', ...props }: MrxMapsNavigationIconProps) {
  return (
...
export default MrxMapsNavigationIcon;
