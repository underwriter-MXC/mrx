...
export interface MrxMapsDistanceIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxMapsDistanceIcon({ title = 'Distance', ...props }: MrxMapsDistanceIconProps) {
  return (
...
export default MrxMapsDistanceIcon;
