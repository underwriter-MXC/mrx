...
export interface MrxMapsUnitedStatesIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxMapsUnitedStatesIcon({ title = 'United States', ...props }: MrxMapsUnitedStatesIconProps) {
  return (
...
export default MrxMapsUnitedStatesIcon;
