...
export interface MrxMapsLocationPinIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxMapsLocationPinIcon({ title = 'Location Pin', ...props }: MrxMapsLocationPinIconProps) {
  return (
...
export default MrxMapsLocationPinIcon;
