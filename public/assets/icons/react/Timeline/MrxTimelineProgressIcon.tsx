...
export interface MrxTimelineProgressIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxTimelineProgressIcon({ title = 'Progress', ...props }: MrxTimelineProgressIconProps) {
  return (
...
export default MrxTimelineProgressIcon;
