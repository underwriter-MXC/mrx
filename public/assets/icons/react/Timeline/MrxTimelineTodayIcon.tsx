...
export interface MrxTimelineTodayIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxTimelineTodayIcon({ title = 'Today', ...props }: MrxTimelineTodayIconProps) {
  return (
...
export default MrxTimelineTodayIcon;
