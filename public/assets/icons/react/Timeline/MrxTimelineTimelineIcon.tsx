...
export interface MrxTimelineTimelineIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxTimelineTimelineIcon({ title = 'Timeline', ...props }: MrxTimelineTimelineIconProps) {
  return (
...
export default MrxTimelineTimelineIcon;
