...
export interface MrxTimelineFutureIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxTimelineFutureIcon({ title = 'Future', ...props }: MrxTimelineFutureIconProps) {
  return (
...
export default MrxTimelineFutureIcon;
