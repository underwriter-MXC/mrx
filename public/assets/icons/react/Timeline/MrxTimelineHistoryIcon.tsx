...
export interface MrxTimelineHistoryIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxTimelineHistoryIcon({ title = 'History', ...props }: MrxTimelineHistoryIconProps) {
  return (
...
export default MrxTimelineHistoryIcon;
