...
export interface MrxTimelineRecentIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxTimelineRecentIcon({ title = 'Recent', ...props }: MrxTimelineRecentIconProps) {
  return (
...
export default MrxTimelineRecentIcon;
