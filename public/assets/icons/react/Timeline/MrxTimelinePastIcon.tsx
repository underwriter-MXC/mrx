...
export interface MrxTimelinePastIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxTimelinePastIcon({ title = 'Past', ...props }: MrxTimelinePastIconProps) {
  return (
...
export default MrxTimelinePastIcon;
