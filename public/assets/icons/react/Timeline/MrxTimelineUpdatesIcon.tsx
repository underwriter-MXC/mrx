...
export interface MrxTimelineUpdatesIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxTimelineUpdatesIcon({ title = 'Updates', ...props }: MrxTimelineUpdatesIconProps) {
  return (
...
export default MrxTimelineUpdatesIcon;
