...
export interface MrxTimelineCalendarIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxTimelineCalendarIcon({ title = 'Calendar', ...props }: MrxTimelineCalendarIconProps) {
  return (
...
export default MrxTimelineCalendarIcon;
