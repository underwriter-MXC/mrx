...
export interface MrxTimelineMilestoneIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxTimelineMilestoneIcon({ title = 'Milestone', ...props }: MrxTimelineMilestoneIconProps) {
  return (
...
export default MrxTimelineMilestoneIcon;
