...
export interface MrxTimelineActivityIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxTimelineActivityIcon({ title = 'Activity', ...props }: MrxTimelineActivityIconProps) {
  return (
...
export default MrxTimelineActivityIcon;
