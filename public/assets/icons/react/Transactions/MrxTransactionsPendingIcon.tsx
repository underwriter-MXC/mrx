...
export interface MrxTransactionsPendingIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxTransactionsPendingIcon({ title = 'Pending', ...props }: MrxTransactionsPendingIconProps) {
  return (
...
export default MrxTransactionsPendingIcon;
