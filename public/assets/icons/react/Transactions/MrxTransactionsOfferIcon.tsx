...
export interface MrxTransactionsOfferIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxTransactionsOfferIcon({ title = 'Offer', ...props }: MrxTransactionsOfferIconProps) {
  return (
...
export default MrxTransactionsOfferIcon;
