...
export interface MrxTransactionsBankIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxTransactionsBankIcon({ title = 'Bank', ...props }: MrxTransactionsBankIconProps) {
  return (
...
export default MrxTransactionsBankIcon;
