...
export interface MrxTransactionsClosingIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxTransactionsClosingIcon({ title = 'Closing', ...props }: MrxTransactionsClosingIconProps) {
  return (
...
export default MrxTransactionsClosingIcon;
