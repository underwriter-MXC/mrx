...
export interface MrxTransactionsWalletIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxTransactionsWalletIcon({ title = 'Wallet', ...props }: MrxTransactionsWalletIconProps) {
  return (
...
export default MrxTransactionsWalletIcon;
