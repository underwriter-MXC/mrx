...
export interface MrxTransactionsCompletedIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxTransactionsCompletedIcon({ title = 'Completed', ...props }: MrxTransactionsCompletedIconProps) {
  return (
...
export default MrxTransactionsCompletedIcon;
