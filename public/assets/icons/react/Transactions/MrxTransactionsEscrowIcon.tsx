...
export interface MrxTransactionsEscrowIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxTransactionsEscrowIcon({ title = 'Escrow', ...props }: MrxTransactionsEscrowIconProps) {
  return (
...
export default MrxTransactionsEscrowIcon;
