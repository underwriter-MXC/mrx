...
export interface MrxTransactionsSellIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxTransactionsSellIcon({ title = 'Sell', ...props }: MrxTransactionsSellIconProps) {
  return (
...
export default MrxTransactionsSellIcon;
