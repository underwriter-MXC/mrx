...
export interface MrxTransactionsPaymentIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxTransactionsPaymentIcon({ title = 'Payment', ...props }: MrxTransactionsPaymentIconProps) {
  return (
...
export default MrxTransactionsPaymentIcon;
