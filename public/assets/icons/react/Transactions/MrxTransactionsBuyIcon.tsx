...
export interface MrxTransactionsBuyIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxTransactionsBuyIcon({ title = 'Buy', ...props }: MrxTransactionsBuyIconProps) {
  return (
...
export default MrxTransactionsBuyIcon;
