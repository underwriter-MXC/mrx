...
export interface MrxTransactionsCashIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxTransactionsCashIcon({ title = 'Cash', ...props }: MrxTransactionsCashIconProps) {
  return (
...
export default MrxTransactionsCashIcon;
