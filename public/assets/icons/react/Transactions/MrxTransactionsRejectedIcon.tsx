...
export interface MrxTransactionsRejectedIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxTransactionsRejectedIcon({ title = 'Rejected', ...props }: MrxTransactionsRejectedIconProps) {
  return (
...
export default MrxTransactionsRejectedIcon;
