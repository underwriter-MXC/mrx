...
export interface MrxTrustSecureIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxTrustSecureIcon({ title = 'Secure', ...props }: MrxTrustSecureIconProps) {
  return (
...
export default MrxTrustSecureIcon;
