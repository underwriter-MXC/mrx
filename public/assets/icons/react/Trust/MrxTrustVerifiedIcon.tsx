...
export interface MrxTrustVerifiedIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxTrustVerifiedIcon({ title = 'Verified', ...props }: MrxTrustVerifiedIconProps) {
  return (
...
export default MrxTrustVerifiedIcon;
