...
export interface MrxTrustShieldCheckIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxTrustShieldCheckIcon({ title = 'Shield Check', ...props }: MrxTrustShieldCheckIconProps) {
  return (
...
export default MrxTrustShieldCheckIcon;
