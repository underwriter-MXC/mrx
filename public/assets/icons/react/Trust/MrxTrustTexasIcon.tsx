...
export interface MrxTrustTexasIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxTrustTexasIcon({ title = 'Texas', ...props }: MrxTrustTexasIconProps) {
  return (
...
export default MrxTrustTexasIcon;
