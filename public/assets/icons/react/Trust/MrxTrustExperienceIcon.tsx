...
export interface MrxTrustExperienceIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxTrustExperienceIcon({ title = 'Experience', ...props }: MrxTrustExperienceIconProps) {
  return (
...
export default MrxTrustExperienceIcon;
