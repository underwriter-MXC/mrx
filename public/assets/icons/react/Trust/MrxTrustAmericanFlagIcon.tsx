...
export interface MrxTrustAmericanFlagIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxTrustAmericanFlagIcon({ title = 'American Flag', ...props }: MrxTrustAmericanFlagIconProps) {
  return (
...
export default MrxTrustAmericanFlagIcon;
