...
export interface MrxTrustSslIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxTrustSslIcon({ title = 'SSL', ...props }: MrxTrustSslIconProps) {
  return (
...
export default MrxTrustSslIcon;
