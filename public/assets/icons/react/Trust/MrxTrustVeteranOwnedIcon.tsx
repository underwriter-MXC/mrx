...
export interface MrxTrustVeteranOwnedIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxTrustVeteranOwnedIcon({ title = 'Veteran Owned', ...props }: MrxTrustVeteranOwnedIconProps) {
  return (
...
export default MrxTrustVeteranOwnedIcon;
