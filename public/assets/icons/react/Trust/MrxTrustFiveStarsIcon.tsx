...
export interface MrxTrustFiveStarsIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxTrustFiveStarsIcon({ title = 'Five Stars', ...props }: MrxTrustFiveStarsIconProps) {
  return (
...
export default MrxTrustFiveStarsIcon;
