...
export interface MrxTrustPrivacyIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxTrustPrivacyIcon({ title = 'Privacy', ...props }: MrxTrustPrivacyIconProps) {
  return (
...
export default MrxTrustPrivacyIcon;
