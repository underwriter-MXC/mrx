...
export interface MrxTrustInsuranceIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxTrustInsuranceIcon({ title = 'Insurance', ...props }: MrxTrustInsuranceIconProps) {
  return (
...
export default MrxTrustInsuranceIcon;
