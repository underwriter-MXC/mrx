...
export interface MrxTrustFamilyOwnedIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxTrustFamilyOwnedIcon({ title = 'Family Owned', ...props }: MrxTrustFamilyOwnedIconProps) {
  return (
...
export default MrxTrustFamilyOwnedIcon;
