...
export interface MrxCommunicationPhoneIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxCommunicationPhoneIcon({ title = 'Phone', ...props }: MrxCommunicationPhoneIconProps) {
  return (
...
export default MrxCommunicationPhoneIcon;
