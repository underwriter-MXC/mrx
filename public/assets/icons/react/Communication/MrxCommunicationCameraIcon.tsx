...
export interface MrxCommunicationCameraIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxCommunicationCameraIcon({ title = 'Camera', ...props }: MrxCommunicationCameraIconProps) {
  return (
...
export default MrxCommunicationCameraIcon;
