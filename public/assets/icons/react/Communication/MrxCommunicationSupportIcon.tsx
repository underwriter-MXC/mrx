...
export interface MrxCommunicationSupportIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxCommunicationSupportIcon({ title = 'Support', ...props }: MrxCommunicationSupportIconProps) {
  return (
...
export default MrxCommunicationSupportIcon;
