...
export interface MrxCommunicationCustomerServiceIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxCommunicationCustomerServiceIcon({ title = 'Customer Service', ...props }: MrxCommunicationCustomerServiceIconProps) {
  return (
...
export default MrxCommunicationCustomerServiceIcon;
