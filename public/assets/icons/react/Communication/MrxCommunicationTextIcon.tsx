...
export interface MrxCommunicationTextIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxCommunicationTextIcon({ title = 'Text', ...props }: MrxCommunicationTextIconProps) {
  return (
...
export default MrxCommunicationTextIcon;
