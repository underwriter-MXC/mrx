...
export interface MrxCommunicationFaqIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxCommunicationFaqIcon({ title = 'FAQ', ...props }: MrxCommunicationFaqIconProps) {
  return (
...
export default MrxCommunicationFaqIcon;
