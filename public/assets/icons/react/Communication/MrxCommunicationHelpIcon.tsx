...
export interface MrxCommunicationHelpIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxCommunicationHelpIcon({ title = 'Help', ...props }: MrxCommunicationHelpIconProps) {
  return (
...
export default MrxCommunicationHelpIcon;
