...
export interface MrxCommunicationEmailIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxCommunicationEmailIcon({ title = 'Email', ...props }: MrxCommunicationEmailIconProps) {
  return (
...
export default MrxCommunicationEmailIcon;
