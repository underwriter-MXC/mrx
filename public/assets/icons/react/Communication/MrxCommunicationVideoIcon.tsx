...
export interface MrxCommunicationVideoIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxCommunicationVideoIcon({ title = 'Video', ...props }: MrxCommunicationVideoIconProps) {
  return (
...
export default MrxCommunicationVideoIcon;
