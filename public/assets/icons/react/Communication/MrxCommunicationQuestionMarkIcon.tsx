...
export interface MrxCommunicationQuestionMarkIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxCommunicationQuestionMarkIcon({ title = 'Question Mark', ...props }: MrxCommunicationQuestionMarkIconProps) {
  return (
...
export default MrxCommunicationQuestionMarkIcon;
