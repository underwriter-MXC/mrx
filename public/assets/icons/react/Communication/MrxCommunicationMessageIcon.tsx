...
export interface MrxCommunicationMessageIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxCommunicationMessageIcon({ title = 'Message', ...props }: MrxCommunicationMessageIconProps) {
  return (
...
export default MrxCommunicationMessageIcon;
