...
export interface MrxCommunicationBellIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxCommunicationBellIcon({ title = 'Bell', ...props }: MrxCommunicationBellIconProps) {
  return (
...
export default MrxCommunicationBellIcon;
