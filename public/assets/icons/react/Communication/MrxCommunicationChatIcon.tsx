...
export interface MrxCommunicationChatIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxCommunicationChatIcon({ title = 'Chat', ...props }: MrxCommunicationChatIconProps) {
  return (
...
export default MrxCommunicationChatIcon;
