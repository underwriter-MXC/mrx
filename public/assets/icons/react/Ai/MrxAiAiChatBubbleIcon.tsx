...
export interface MrxAiAiChatBubbleIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxAiAiChatBubbleIcon({ title = 'AI Chat Bubble', ...props }: MrxAiAiChatBubbleIconProps) {
  return (
...
export default MrxAiAiChatBubbleIcon;
