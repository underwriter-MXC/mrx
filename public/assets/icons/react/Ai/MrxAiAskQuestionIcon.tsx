...
export interface MrxAiAskQuestionIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxAiAskQuestionIcon({ title = 'Ask Question', ...props }: MrxAiAskQuestionIconProps) {
  return (
...
export default MrxAiAskQuestionIcon;
