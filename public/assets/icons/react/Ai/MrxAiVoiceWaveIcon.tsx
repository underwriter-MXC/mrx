...
export interface MrxAiVoiceWaveIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxAiVoiceWaveIcon({ title = 'Voice Wave', ...props }: MrxAiVoiceWaveIconProps) {
  return (
...
export default MrxAiVoiceWaveIcon;
