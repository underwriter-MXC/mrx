...
export interface MrxAiConnectedNodesIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxAiConnectedNodesIcon({ title = 'Connected Nodes', ...props }: MrxAiConnectedNodesIconProps) {
  return (
...
export default MrxAiConnectedNodesIcon;
