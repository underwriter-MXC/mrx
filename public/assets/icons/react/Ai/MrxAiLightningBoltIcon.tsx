...
export interface MrxAiLightningBoltIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxAiLightningBoltIcon({ title = 'Lightning Bolt', ...props }: MrxAiLightningBoltIconProps) {
  return (
...
export default MrxAiLightningBoltIcon;
