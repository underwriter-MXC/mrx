...
export interface MrxAiBrainIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxAiBrainIcon({ title = 'Brain', ...props }: MrxAiBrainIconProps) {
  return (
