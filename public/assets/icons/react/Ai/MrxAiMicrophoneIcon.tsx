...
export interface MrxAiMicrophoneIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxAiMicrophoneIcon({ title = 'Microphone', ...props }: MrxAiMicrophoneIconProps) {
  return (
...
export default MrxAiMicrophoneIcon;
