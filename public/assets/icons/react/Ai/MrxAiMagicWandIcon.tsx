...
export interface MrxAiMagicWandIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxAiMagicWandIcon({ title = 'Magic Wand', ...props }: MrxAiMagicWandIconProps) {
  return (
...
export default MrxAiMagicWandIcon;
