...
export interface MrxAiAutomationIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxAiAutomationIcon({ title = 'Automation', ...props }: MrxAiAutomationIconProps) {
  return (
...
export default MrxAiAutomationIcon;
