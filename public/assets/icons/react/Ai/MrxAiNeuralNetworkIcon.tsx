...
export interface MrxAiNeuralNetworkIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxAiNeuralNetworkIcon({ title = 'Neural Network', ...props }: MrxAiNeuralNetworkIconProps) {
  return (
...
export default MrxAiNeuralNetworkIcon;
