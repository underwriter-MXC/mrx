...
export interface MrxAiSparkIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxAiSparkIcon({ title = 'Spark', ...props }: MrxAiSparkIconProps) {
  return (
