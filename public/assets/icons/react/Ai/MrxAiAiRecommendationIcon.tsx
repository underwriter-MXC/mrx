...
export interface MrxAiAiRecommendationIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxAiAiRecommendationIcon({ title = 'AI Recommendation', ...props }: MrxAiAiRecommendationIconProps) {
  return (
...
export default MrxAiAiRecommendationIcon;
