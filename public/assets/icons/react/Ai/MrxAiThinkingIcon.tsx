...
export interface MrxAiThinkingIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxAiThinkingIcon({ title = 'Thinking', ...props }: MrxAiThinkingIconProps) {
  return (
...
export default MrxAiThinkingIcon;
