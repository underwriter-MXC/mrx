...
export interface MrxAiRobotHeadIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxAiRobotHeadIcon({ title = 'Robot Head', ...props }: MrxAiRobotHeadIconProps) {
  return (
...
export default MrxAiRobotHeadIcon;
