...
export interface MrxAiAiShieldIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxAiAiShieldIcon({ title = 'AI Shield', ...props }: MrxAiAiShieldIconProps) {
  return (
...
export default MrxAiAiShieldIcon;
