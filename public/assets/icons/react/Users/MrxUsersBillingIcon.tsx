...
export interface MrxUsersBillingIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxUsersBillingIcon({ title = 'Billing', ...props }: MrxUsersBillingIconProps) {
  return (
...
export default MrxUsersBillingIcon;
