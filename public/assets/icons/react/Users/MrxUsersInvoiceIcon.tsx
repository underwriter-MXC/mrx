...
export interface MrxUsersInvoiceIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxUsersInvoiceIcon({ title = 'Invoice', ...props }: MrxUsersInvoiceIconProps) {
  return (
...
export default MrxUsersInvoiceIcon;
