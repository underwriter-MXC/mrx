...
export interface MrxUsersAvatarIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxUsersAvatarIcon({ title = 'Avatar', ...props }: MrxUsersAvatarIconProps) {
  return (
...
export default MrxUsersAvatarIcon;
