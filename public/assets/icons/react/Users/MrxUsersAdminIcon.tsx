...
export interface MrxUsersAdminIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxUsersAdminIcon({ title = 'Admin', ...props }: MrxUsersAdminIconProps) {
  return (
...
export default MrxUsersAdminIcon;
