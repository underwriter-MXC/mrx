...
export interface MrxUsersPersonIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxUsersPersonIcon({ title = 'Person', ...props }: MrxUsersPersonIconProps) {
  return (
...
export default MrxUsersPersonIcon;
