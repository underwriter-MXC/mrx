...
export interface MrxUsersMultipleUsersIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxUsersMultipleUsersIcon({ title = 'Multiple Users', ...props }: MrxUsersMultipleUsersIconProps) {
  return (
...
export default MrxUsersMultipleUsersIcon;
