...
export interface MrxUsersUserSettingsIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxUsersUserSettingsIcon({ title = 'User Settings', ...props }: MrxUsersUserSettingsIconProps) {
  return (
...
export default MrxUsersUserSettingsIcon;
