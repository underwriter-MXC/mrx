...
export interface MrxUsersCreditCardIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxUsersCreditCardIcon({ title = 'Credit Card', ...props }: MrxUsersCreditCardIconProps) {
  return (
...
export default MrxUsersCreditCardIcon;
