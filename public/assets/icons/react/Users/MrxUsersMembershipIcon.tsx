...
export interface MrxUsersMembershipIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxUsersMembershipIcon({ title = 'Membership', ...props }: MrxUsersMembershipIconProps) {
  return (
...
export default MrxUsersMembershipIcon;
