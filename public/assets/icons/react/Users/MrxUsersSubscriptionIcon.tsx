...
export interface MrxUsersSubscriptionIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxUsersSubscriptionIcon({ title = 'Subscription', ...props }: MrxUsersSubscriptionIconProps) {
  return (
...
export default MrxUsersSubscriptionIcon;
