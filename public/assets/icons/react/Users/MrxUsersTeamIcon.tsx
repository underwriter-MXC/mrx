...
export interface MrxUsersTeamIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxUsersTeamIcon({ title = 'Team', ...props }: MrxUsersTeamIconProps) {
  return (
...
export default MrxUsersTeamIcon;
