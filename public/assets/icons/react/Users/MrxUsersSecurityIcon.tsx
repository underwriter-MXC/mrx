...
export interface MrxUsersSecurityIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxUsersSecurityIcon({ title = 'Security', ...props }: MrxUsersSecurityIconProps) {
  return (
...
export default MrxUsersSecurityIcon;
