...
export interface MrxUsersReceiptIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxUsersReceiptIcon({ title = 'Receipt', ...props }: MrxUsersReceiptIconProps) {
  return (
...
export default MrxUsersReceiptIcon;
