...
export interface MrxUsersPasswordIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxUsersPasswordIcon({ title = 'Password', ...props }: MrxUsersPasswordIconProps) {
  return (
...
export default MrxUsersPasswordIcon;
