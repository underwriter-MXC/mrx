...
export interface MrxUsersProfileIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string;
}

export function MrxUsersProfileIcon({ title = 'Profile', ...props }: MrxUsersProfileIconProps) {
  return (
...
export default MrxUsersProfileIcon;
