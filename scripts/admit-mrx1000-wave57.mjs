...
const primaryKeyword = 'What Information Do I Need to Provide for a Mineral Rights Review?';
const keyword = primaryKeyword;
const programRowId = 'MRX1000-0137';
const selectionRank = 137;
...
const decisionRelativePath = 'docs/governance/mrx1000-wave57-selection-decision-2026-08-13.md';
const creativeManifestRelativePath = `artifacts/mrx1000-wave57-creative-qa/${slug}/creative-manifest.json`;
...
async function writeReviewPlaceholder(relativePath, capability, now) {
  ...
  const artifact = {
    artifact_type: 'mrx1000_wave57_review_placeholder',
...
const requiredDecisionId = 'MRX1000-W57-SELECT-2026-08-13';
if (
  ...
  throw new Error('Wave 57 selection decision remains draft-only and is not publication authority');
}
if (
...
const retrofitRow = {
  ...
  inline: {
    ...
    visual_variant: 'wave57-distinct-generated-review-intake-matrix',
...
const batchRow = {
  ...
  risk_citation_remediation: [
    'The planning-only canonical row was developed into an original review-intake identity and evidence-usability guide. It defines the owner question and evidence cutoff, prioritizes property and record identifiers, separates ownership, lease, payment, operating, and offer evidence, preserves support-status labels and conflicts, protects sensitive information, and states pause and professional-handoff conditions without importing factory body text or duplicating meeting logistics, sale-document, broad value-checklist, workflow, methodology, title, legal, tax, appraisal, or transaction pages.',
    'Continuous quality-gated admission under D-2026-0804-16 and MRX1000-W57-SELECT-2026-08-13; no numerical cap or elapsed-time gate applies.',
...
batch.decision_authority.wave57_selection_decision_id = 'MRX1000-W57-SELECT-2026-08-13';
batch.decision_authority.wave57_selection_decision_path = decisionRelativePath;
batch.decision_authority.wave57_selection_decision_sha256 = sha256(decisionBytes);
