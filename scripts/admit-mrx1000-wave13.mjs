...
const slug = 'basis-differentials-and-mineral-rights-cash-flow';
const title = 'Basis Differentials and Mineral Rights Cash Flow';
const primaryKeyword = 'basis differentials mineral rights cash flow';
const keyword = 'basis differential royalty statement';
const programRowId = 'MRX1000-0171';
const selectionRank = 93;
...
const decisionRelativePath = 'docs/governance/mrx1000-wave13-selection-decision-2026-08-11.md';
const creativeManifestRelativePath =
  'artifacts/mrx1000-wave13-creative-qa/basis-differentials-and-mineral-rights-cash-flow/creative-manifest.json';
...
async function writeReviewPlaceholder(relativePath, capability, now) {
  ...
  const artifact = {
    artifact_type: 'mrx1000_wave13_review_placeholder',
...
const retrofitRow = {
  ...
  inline: {
    ...
    visual_variant: 'wave13-distinct-generated-royalty-reconciliation',
...
const batchRow = {
  ...
  risk_citation_remediation: [
    'The planning-only canonical row was developed into an original, evidence-bounded owner guide; no factory body text was imported.',
    'Continuous quality-gated admission under D-2026-0804-16 and MRX1000-W13-SELECT-2026-08-11; no numerical cap or elapsed-time gate applies.',
...
batch.decision_authority.wave13_selection_decision_id = 'MRX1000-W13-SELECT-2026-08-11';
batch.decision_authority.wave13_selection_decision_path = decisionRelativePath;
batch.decision_authority.wave13_selection_decision_sha256 = sha256(decisionBytes);
