...
const primaryKeyword = 'How Do I Know if My Mineral Rights Qualify for Evaluation?';
const keyword = primaryKeyword;
const programRowId = 'MRX1000-0180';
const selectionRank = 102;
...
const decisionRelativePath = 'docs/governance/mrx1000-wave22-selection-decision-2026-08-11.md';
const creativeManifestRelativePath =
  'artifacts/mrx1000-wave22-creative-qa/five-key-indicators-that-show-your-mineral-rights-are-ready-for-evaluation/creative-manifest.json';
...
async function writeReviewPlaceholder(relativePath, capability, now) {
  ...
  const artifact = {
    artifact_type: 'mrx1000_wave22_review_placeholder',
...
const retrofitRow = {
  ...
  inline: {
    ...
    visual_variant: 'wave22-distinct-generated-evidence-readiness-wall',
...
const batchRow = {
  ...
  risk_citation_remediation: [
    'The planning-only canonical row was developed into an original, evidence-first evaluation-readiness framework that separates documented facts, missing records, and assumptions; no factory body text was imported.',
    'Continuous quality-gated admission under D-2026-0804-16 and MRX1000-W22-SELECT-2026-08-11; no numerical cap or elapsed-time gate applies.',
...
batch.decision_authority.wave22_selection_decision_id = 'MRX1000-W22-SELECT-2026-08-11';
batch.decision_authority.wave22_selection_decision_path = decisionRelativePath;
batch.decision_authority.wave22_selection_decision_sha256 = sha256(decisionBytes);
