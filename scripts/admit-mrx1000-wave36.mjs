...
const primaryKeyword = 'Common Mistakes Selling Mineral Rights';
const keyword = primaryKeyword;
const programRowId = 'MRX1000-0116';
const selectionRank = 116;
...
const decisionRelativePath = 'docs/governance/mrx1000-wave36-selection-decision-2026-08-12.md';
const creativeManifestRelativePath =
  'artifacts/mrx1000-wave36-creative-qa/the-hidden-traps-in-selling-mineral-rights/creative-manifest.json';
...
async function writeReviewPlaceholder(relativePath, capability, now) {
  ...
  const artifact = {
    artifact_type: 'mrx1000_wave36_review_placeholder',
...
const retrofitRow = {
  ...
  inline: {
    ...
    visual_variant: 'wave36-distinct-generated-contract-trigger-map',
...
const batchRow = {
  ...
  risk_citation_remediation: [
    'The planning-only canonical row was developed into an original nationwide clause-trigger and cross-document trap guide that separates headline terms from operative definitions, exhibits, diligence rights, price adjustments, exclusivity, deed and payment sequencing, remedies, and owner net; it adds a trap register, source-aware limitations, stop rules, and professional handoffs without importing factory body text.',
    'Continuous quality-gated admission under D-2026-0804-16 and MRX1000-W36-SELECT-2026-08-12; no numerical cap or elapsed-time gate applies.',
...
batch.decision_authority.wave36_selection_decision_id = 'MRX1000-W36-SELECT-2026-08-12';
batch.decision_authority.wave36_selection_decision_path = decisionRelativePath;
batch.decision_authority.wave36_selection_decision_sha256 = sha256(decisionBytes);
