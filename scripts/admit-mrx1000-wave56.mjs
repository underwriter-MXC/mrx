...
const primaryKeyword = 'What Is the Typical Pricing Range for Mineral Rights in My Area?';
const keyword = primaryKeyword;
const programRowId = 'MRX1000-0136';
const selectionRank = 136;
...
const decisionRelativePath = 'docs/governance/mrx1000-wave56-selection-decision-2026-08-13.md';
const creativeManifestRelativePath =
  `artifacts/mrx1000-wave56-creative-qa/${slug}/creative-manifest.json`;
...
async function writeReviewPlaceholder(relativePath, capability, now) {
  ...
  const artifact = {
    artifact_type: 'mrx1000_wave56_review_placeholder',
...
const retrofitRow = {
  ...
  inline: {
    ...
    visual_variant: 'wave56-distinct-generated-local-range-evidence-table',
...
const batchRow = {
  ...
  risk_citation_remediation: [
    'The planning-only canonical row was developed into an original property-matched local pricing-range assembly and reporting guide. It defines the relevant area from the asset outward, separates materially different cohorts and evidence lanes, normalizes verified units and terms, reports an evidence envelope with exclusions and confidence, and states when no local range is supportable without importing factory body text or duplicating the comparable-sale screen, factor catalog, methodology guide, or fair-offer review.',
    'Continuous quality-gated admission under D-2026-0804-16 and MRX1000-W56-SELECT-2026-08-13; no numerical cap or elapsed-time gate applies.',
...
batch.decision_authority.wave56_selection_decision_id = 'MRX1000-W56-SELECT-2026-08-13';
batch.decision_authority.wave56_selection_decision_path = decisionRelativePath;
batch.decision_authority.wave56_selection_decision_sha256 = sha256(decisionBytes);
