...
const decisionRelativePath = 'docs/governance/mrx1000-wave35-selection-decision-2026-08-12.md';
const creativeManifestRelativePath =
  'artifacts/mrx1000-wave35-creative-qa/the-comprehensive-guide-to-factors-impacting-your-mineral-rights-valuation/creative-manifest.json';
...
async function writeReviewPlaceholder(relativePath, capability, now) {
  ...
  const artifact = {
    artifact_type: 'mrx1000_wave35_review_placeholder',
...
const retrofitRow = {
  ...
  inline: {
    ...
    visual_variant: 'wave35-distinct-generated-factor-to-range-traceability-map',
...
const batchRow = {
  ...
  risk_citation_remediation: [
    'The planning-only canonical row was developed into an original nationwide factor-to-range traceability guide that separates property scope, evidence classes, model assumptions, scenario interactions, a directional asset range, complete buyer terms, and expected owner net; it adds a factor register, sensitivity bridge, source-aware limitations, stop rules, and professional handoffs without importing factory body text.',
    'Continuous quality-gated admission under D-2026-0804-16 and MRX1000-W35-SELECT-2026-08-12; no numerical cap or elapsed-time gate applies.',
...
batch.decision_authority.wave35_selection_decision_id = 'MRX1000-W35-SELECT-2026-08-12';
batch.decision_authority.wave35_selection_decision_path = decisionRelativePath;
batch.decision_authority.wave35_selection_decision_sha256 = sha256(decisionBytes);
