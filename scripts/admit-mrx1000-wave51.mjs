...
const primaryKeyword = 'Mineral Rights Selling Process Errors';
const keyword = primaryKeyword;
const programRowId = 'MRX1000-0131';
const selectionRank = 131;
...
const decisionRelativePath = 'docs/governance/mrx1000-wave51-selection-decision-2026-08-12.md';
const creativeManifestRelativePath =
  `artifacts/mrx1000-wave51-creative-qa/${slug}/creative-manifest.json`;
...
async function writeReviewPlaceholder(relativePath, capability, now) {
  ...
  const artifact = {
    artifact_type: 'mrx1000_wave51_review_placeholder',
...
const retrofitRow = {
  ...
  inline: {
    ...
    visual_variant: 'wave51-distinct-generated-eight-class-assessment-error-register',
...
const batchRow = {
  ...
  risk_citation_remediation: [
    'The planning-only canonical row was developed into an original assessment-error detection and correction guide. It distinguishes errors, evidence gaps, and reasonable scenario differences; covers eight error classes; and gives each issue a detection test, containment action, correction record, limited rerun scope, and reset trigger without importing factory body text or duplicating the end-to-end sale-missteps, clause-traps, seller-readiness, or suggested-price-bridge guides.',
    'Continuous quality-gated admission under D-2026-0804-16 and MRX1000-W51-SELECT-2026-08-12; no numerical cap or elapsed-time gate applies.',
...
batch.decision_authority.wave51_selection_decision_id = 'MRX1000-W51-SELECT-2026-08-12';
batch.decision_authority.wave51_selection_decision_path = decisionRelativePath;
batch.decision_authority.wave51_selection_decision_sha256 = sha256(decisionBytes);
