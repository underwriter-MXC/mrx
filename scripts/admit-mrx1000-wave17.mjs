...
const primaryKeyword = 'decline curves and future royalty cash flow';
const keyword = 'decline curve royalty cash flow worksheet';
const programRowId = 'MRX1000-0175';
const selectionRank = 97;
...
const decisionRelativePath = 'docs/governance/mrx1000-wave17-selection-decision-2026-08-11.md';
const creativeManifestRelativePath =
  'artifacts/mrx1000-wave17-creative-qa/decline-curves-and-future-royalty-cash-flow/creative-manifest.json';
...
async function writeReviewPlaceholder(relativePath, capability, now) {
  ...
  const artifact = {
    artifact_type: 'mrx1000_wave17_review_placeholder',
...
const retrofitRow = {
  ...
  inline: {
    ...
    visual_variant: 'wave17-distinct-generated-production-analysis-workspace',
...
const batchRow = {
  ...
  risk_citation_remediation: [
    'The planning-only canonical row was developed into an original, evidence-bounded decline-curve and future royalty cash-flow guide; no factory body text was imported.',
    'Continuous quality-gated admission under D-2026-0804-16 and MRX1000-W17-SELECT-2026-08-11; no numerical cap or elapsed-time gate applies.',
...
batch.decision_authority.wave17_selection_decision_id = 'MRX1000-W17-SELECT-2026-08-11';
batch.decision_authority.wave17_selection_decision_path = decisionRelativePath;
batch.decision_authority.wave17_selection_decision_sha256 = sha256(decisionBytes);
