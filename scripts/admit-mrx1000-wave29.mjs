...
const primaryKeyword = 'how much are mineral rights worth';
const keyword = primaryKeyword;
const programRowId = 'MRX1000-0187';
const selectionRank = 109;
...
const decisionRelativePath = 'docs/governance/mrx1000-wave29-selection-decision-2026-08-12.md';
const creativeManifestRelativePath =
  'artifacts/mrx1000-wave29-creative-qa/how-much-are-mineral-rights-worth-due-diligence-step-by-step/creative-manifest.json';
...
async function writeReviewPlaceholder(relativePath, capability, now) {
  ...
  const artifact = {
    artifact_type: 'mrx1000_wave29_review_placeholder',
...
const retrofitRow = {
  ...
  inline: {
    ...
    visual_variant: 'wave29-distinct-generated-valuation-decision-gate-board',
...
const batchRow = {
  ...
  risk_citation_remediation: [
    'The planning-only canonical row was developed into an original ordered valuation due-diligence workflow with explicit interest-scope, record-match, payment, production, development, modeling, tax-lane, and specialist-handoff checkpoints; no factory body text was imported.',
    'Continuous quality-gated admission under D-2026-0804-16 and MRX1000-W29-SELECT-2026-08-12; no numerical cap or elapsed-time gate applies.',
...
batch.decision_authority.wave29_selection_decision_id = 'MRX1000-W29-SELECT-2026-08-12';
batch.decision_authority.wave29_selection_decision_path = decisionRelativePath;
batch.decision_authority.wave29_selection_decision_sha256 = sha256(decisionBytes);
