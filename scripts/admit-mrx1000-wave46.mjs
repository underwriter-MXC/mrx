...
const primaryKeyword = 'How to Avoid Mineral Rights Selling Pitfalls';
const keyword = primaryKeyword;
const programRowId = 'MRX1000-0126';
const selectionRank = 126;
...
const decisionRelativePath = 'docs/governance/mrx1000-wave46-selection-decision-2026-08-12.md';
const creativeManifestRelativePath =
  'artifacts/mrx1000-wave46-creative-qa/understanding-mineral-rights-your-essential-selling-guide/creative-manifest.json';
...
async function writeReviewPlaceholder(relativePath, capability, now) {
  ...
  const artifact = {
    artifact_type: 'mrx1000_wave46_review_placeholder',
...
const retrofitRow = {
  ...
  inline: {
    ...
    visual_variant: 'wave46-distinct-generated-seven-checkpoint-seller-stage-gate-system',
...
const batchRow = {
  ...
  risk_citation_remediation: [
    'The planning-only canonical row was developed into an original seven-gate seller-readiness guide that separates objective and asset scope, evidence, directional value context, complete proposal review, counterparty and channel verification, professional review and version lock, and controlled closing plus retained records. Each gate has an observable advance, pause, or stop condition without importing factory body text or duplicating the existing five-missteps and contract-traps guides.',
    'Continuous quality-gated admission under D-2026-0804-16 and MRX1000-W46-SELECT-2026-08-12; no numerical cap or elapsed-time gate applies.',
...
batch.decision_authority.wave46_selection_decision_id = 'MRX1000-W46-SELECT-2026-08-12';
batch.decision_authority.wave46_selection_decision_path = decisionRelativePath;
batch.decision_authority.wave46_selection_decision_sha256 = sha256(decisionBytes);
