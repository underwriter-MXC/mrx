...
const title =
  'Understanding the Key Factors That Affect Your Mineral Rights Assessment Price';
const primaryKeyword = 'What Factors Influence the Price You Suggest for My Mineral Rights Assessment?';
const keyword = primaryKeyword;
const programRowId = 'MRX1000-0130';
const selectionRank = 130;
...
const decisionRelativePath = 'docs/governance/mrx1000-wave50-selection-decision-2026-08-12.md';
const creativeManifestRelativePath =
  `artifacts/mrx1000-wave50-creative-qa/${slug}/creative-manifest.json`;
...
async function writeReviewPlaceholder(relativePath, capability, now) {
  ...
  const artifact = {
    artifact_type: 'mrx1000_wave50_review_placeholder',
...
const retrofitRow = {
  ...
  inline: {
    ...
    visual_variant: 'wave50-distinct-generated-six-stage-assessment-price-bridge',
...
const batchRow = {
  ...
  risk_citation_remediation: [
    'The planning-only canonical row was developed into an original suggested-assessment-price audit guide. It separates a gross conditional range, evidence support, transaction proposal, and expected owner net; traces six evidence groups through a change log; and supplies source-status, challenge-question, and reset controls without importing factory body text or duplicating the five-layer valuation-mechanics, broad factor-list, offer-range, or introductory value-driver guides.',
    'Continuous quality-gated admission under D-2026-0804-16 and MRX1000-W50-SELECT-2026-08-12; no numerical cap or elapsed-time gate applies.',
...
batch.decision_authority.wave50_selection_decision_id = 'MRX1000-W50-SELECT-2026-08-12';
batch.decision_authority.wave50_selection_decision_path = decisionRelativePath;
batch.decision_authority.wave50_selection_decision_sha256 = sha256(decisionBytes);
