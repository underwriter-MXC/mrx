...
export function buildManifest() {
  ...
  invariant(
    aggregate.vendor_exact_title_match_rows === 147 &&
      aggregate.vendor_unambiguous_candidate_rows === 141 &&
      aggregate.vendor_ambiguous_candidate_rows === 6 &&
      aggregate.vendor_exact_title_candidate_records === 154 &&
      aggregate.unique_vendor_exact_title_candidate_uuids === 154 &&
      aggregate.vendor_candidate_records_reverified_against_source === 154 &&
