...
const slug = 'essential-steps-to-assess-the-value-of-your-mineral-rights-accurately-and-confidently';
const title =
  'Essential Steps to Assess the Value of Your Mineral Rights Accurately and Confidently';
const primaryKeyword = "What Steps Should I Take to Understand My Mineral Rights' Value?";
const keyword = primaryKeyword;
const programRowId = 'MRX1000-0178';
const selectionRank = 100;
...
const decisionRelativePath = 'docs/governance/mrx1000-wave20-selection-decision-2026-08-11.md';
const creativeManifestRelativePath =
  'artifacts/mrx1000-wave20-creative-qa/essential-steps-to-assess-the-value-of-your-mineral-rights-accurately-and-confidently/creative-manifest.json';
...
async function writeReviewPlaceholder(relativePath, capability, now) {
  ...
  const artifact = {
    artifact_type: 'mrx1000_wave20_review_placeholder',
...
const retrofitRow = {
  ...
  inline: {
    ...
    visual_variant: 'wave20-distinct-generated-evidence-ladder-workspace',
...
const batchRow = {
  ...
  risk_citation_remediation: [
    'The planning-only canonical row was developed into an original, evidence-first mineral-rights value-assessment checklist; no factory body text was imported.',
    'Continuous quality-gated admission under D-2026-0804-16 and MRX1000-W20-SELECT-2026-08-11; no numerical cap or elapsed-time gate applies.',
...
batch.decision_authority.wave20_selection_decision_id = 'MRX1000-W20-SELECT-2026-08-11';
batch.decision_authority.wave20_selection_decision_path = decisionRelativePath;
batch.decision_authority.wave20_selection_decision_sha256 = sha256(decisionBytes);
