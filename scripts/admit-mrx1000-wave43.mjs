...
const primaryKeyword = "How Do I Ensure I'm Receiving a Fair Valuation for My Mineral Rights?";
const keyword = primaryKeyword;
const programRowId = 'MRX1000-0123';
const selectionRank = 123;
...
const decisionRelativePath = 'docs/governance/mrx1000-wave43-selection-decision-2026-08-12.md';
const creativeManifestRelativePath =
  'artifacts/mrx1000-wave43-creative-qa/understanding-mineral-rights-how-to-validate-your-asset-s-true-worth/creative-manifest.json';
...
async function writeReviewPlaceholder(relativePath, capability, now) {
  ...
  const artifact = {
    artifact_type: 'mrx1000_wave43_review_placeholder',
...
const retrofitRow = {
  ...
  inline: {
    ...
    visual_variant: 'wave43-distinct-generated-valuation-reperformance-record',
...
const batchRow = {
  ...
  risk_citation_remediation: [
    'The planning-only canonical row was developed into an original valuation-validation and reperformance protocol. It traces a dated directional range from asset scope and sources through transformations, calculation, sensitivities, variances, and transaction separation without importing factory body text or claiming one guaranteed true value.',
    'Continuous quality-gated admission under D-2026-0804-16 and MRX1000-W43-SELECT-2026-08-12; no numerical cap or elapsed-time gate applies.',
...
batch.decision_authority.wave43_selection_decision_id = 'MRX1000-W43-SELECT-2026-08-12';
batch.decision_authority.wave43_selection_decision_path = decisionRelativePath;
batch.decision_authority.wave43_selection_decision_sha256 = sha256(decisionBytes);
