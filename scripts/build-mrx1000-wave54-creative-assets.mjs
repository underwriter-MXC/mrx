...
const keyword = 'Understanding Texas Mineral Rights Worth';
const inlineFilename =
  'understanding-texas-mineral-rights-worth';
const paths = {
  heroSource: join(root, `artifacts/mrx1000-wave54-creative-sources/${slug}-hero-base.png`),
  inlineSource: join(root, `artifacts/mrx1000-wave54-creative-sources/${slug}-inline-base.png`),
  ...
  qa: join(root, `artifacts/mrx1000-wave54-creative-qa/${slug}`),
};

const generationPrompts = {
  hero:
    'No-people Texas value-question evidence table with a raised-relief tract map, mineral specimen, blank royalty grid, abstract production curves, four brass route markers, and a distant pumpjack beside a deep-navy exact-title field; no extra readable words, numbers, prices, percentages, dates, signatures, private information, logos, legal conclusions, ownership conclusions, value conclusions, buyer claims, or success claims.',
  inline:
    'Compositionally distinct overhead four-lane Texas value-question compass with blank ownership, production, proposal, and professional-purpose evidence objects converging on a blank decision card below a navy exact-keyword field; no extra readable words, numbers, prices, percentages, dates, signatures, private information, logos, legal conclusions, ownership conclusions, value conclusions, buyer claims, or success claims.',
};
  ...
  return Buffer.from(`
    <svg width="1200" height="630" xmlns="http://www.w3.org/2000/svg">
      ...
      <text class="title" x="46" y="201">
        ...
        <tspan x="46" dy="58">Value of Texas</tspan>
  ...
  return Buffer.from(`
    <svg width="1200" height="675" xmlns="http://www.w3.org/2000/svg">
      ...
      <text class="keyword" x="600" y="91">
        <tspan x="600" dy="0">Understanding Texas</tspan>
        <tspan x="600" dy="59">Mineral Rights Worth</tspan>
      </text>
    </svg>
  `);
}
...
async function main() {
  ...
  const tempDirectory = await mkdtemp(join(tmpdir(), 'mrx-wave54-ocr-'));
  try {
