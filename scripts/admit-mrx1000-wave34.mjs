...
const decisionRelativePath = 'docs/governance/mrx1000-wave34-selection-decision-2026-08-12.md';
const creativeManifestRelativePath =
  'artifacts/mrx1000-wave34-creative-qa/selling-mineral-rights-valuation-factors-without-obligation/creative-manifest.json';
...
async function writeReviewPlaceholder(relativePath, capability, now) {
  ...
  const artifact = {
    artifact_type: 'mrx1000_wave34_review_placeholder',
...
const retrofitRow = {
  ...
  inline: {
    ...
    visual_variant: 'wave34-distinct-generated-owner-permission-and-options-path',
...
batch.decision_authority.wave34_selection_decision_id = 'MRX1000-W34-SELECT-2026-08-12';
batch.decision_authority.wave34_selection_decision_path = decisionRelativePath;
batch.decision_authority.wave34_selection_decision_sha256 = sha256(decisionBytes);
