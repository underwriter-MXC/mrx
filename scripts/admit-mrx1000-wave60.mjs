...
if (unknownArgs.length)
  throw new Error(`Unknown Wave 60 admission argument(s): ${unknownArgs.join(', ')}`);
...
const primaryKeyword = 'Texas Mineral Tax Value vs. Sale Estimate';
...
const heroSha256 = '524f75ae1d2adfe70f9080db0bee65faf88e0469bfbe9acb9bbeec25e59bd038';
const inlineSha256 = '987bb495b1e6adda844e28fbfb2bc891ec8985dcda460402762a7e4b9e2dda8c';
const programRowId = 'MRX1000-0140';
const selectionRank = 140;
...
const decisionRelativePath = 'docs/governance/mrx1000-wave60-selection-decision-2026-08-14.md';
const creativeManifestRelativePath = `artifacts/mrx1000-wave60-creative-qa/${slug}/creative-manifest.json`;
...
async function writeReviewPlaceholder(relativePath, capability, now) {
  ...
  const artifact = {
    artifact_type: 'mrx1000_wave60_review_placeholder',
...
const requiredDecisionId = 'MRX1000-W60-SELECT-2026-08-14';
if (
  ...
  throw new Error('Wave 60 selection decision remains draft-only and is not publication authority');
}
if (
  ...
  scalar(fm, 'reviewed_by') !== 'mrx_compliance-continuous-wave60' ||
...
const retrofitRow = {
  ...
  inline: {
    ...
    visual_variant: 'wave60-distinct-generated-tax-value-comparison',
...
if (
  ...
  ledger.articles.some(
    (row) => row.canonical_slug === 'what-determines-the-value-of-your-texas-mineral-rights',
  )
) {
  throw new Error('Wave 60 canonical ledger re-key or 1,000-row uniqueness proof failed');
}
...
const wave60Rekey = ledger.identity_registry.wave60_rekey ?? {
  program_row_id: programRowId,
  prior_canonical_slug: 'what-determines-the-value-of-your-texas-mineral-rights',
  prior_searchatlas_handle:
    'searchatlas-topical-map:254654:title:b304b56e-15c6-47f6-9521-45cae485cf9b',
...
if (wave60Rekey.program_row_id !== programRowId) {
  throw new Error('Wave 60 canonical re-key provenance is missing or drifted');
}
ledger.identity_registry.wave60_rekey = wave60Rekey;
wave60Rekey.draft_selection_decision_sha256 ??= wave60Rekey.selection_decision_sha256;
wave60Rekey.selection_decision_sha256 = sha256(decisionBytes);
wave60Rekey.release_candidate_article_sha256 = articleSha;
wave60Rekey.promoted_at_utc ??= now;
...
const batchRow = {
  ...
  risk_citation_remediation: [
    'The broad planned Texas valuation identity was rejected because existing guides own general value drivers and full valuation workflows. The admitted article owns the distinct reconciliation job between an appraisal-district mineral tax value and a voluntary directional sale estimate: match interest scope, dates, evidence, methods, assumptions, rights, and exclusions, then classify the comparison without creating a new value.',
    'Continuous quality-gated admission under D-2026-0804-16 and MRX1000-W60-SELECT-2026-08-14; no numerical cap or elapsed-time gate applies.',
...
batch.decision_authority.wave60_selection_decision_id = 'MRX1000-W60-SELECT-2026-08-14';
batch.decision_authority.wave60_selection_decision_path = decisionRelativePath;
batch.decision_authority.wave60_selection_decision_sha256 = sha256(decisionBytes);
