...
const primaryKeyword = 'Mineral Rights Appraisal Near Me';
const keyword = primaryKeyword;
const programRowId = 'MRX1000-0125';
const selectionRank = 125;
...
const decisionRelativePath = 'docs/governance/mrx1000-wave45-selection-decision-2026-08-12.md';
const creativeManifestRelativePath =
  `artifacts/mrx1000-wave45-creative-qa/${slug}/creative-manifest.json`;
...
async function writeReviewPlaceholder(relativePath, capability, now) {
  ...
  const artifact = {
    artifact_type: 'mrx1000_wave45_review_placeholder',
...
const retrofitRow = {
  ...
  inline: {
    ...
    visual_variant: 'wave45-distinct-generated-jurisdiction-routing-worktable',
...
const batchRow = {
  ...
  risk_citation_remediation: [
    'The planning-only canonical row was developed into an original location-aware provider and evidence-routing guide. It defines “near me” by the property jurisdiction, records, operating context, intended use, and fit-for-purpose specialist without importing factory body text or treating physical proximity as proof of competence, independence, ownership, value, or appraisal authority.',
    'Continuous quality-gated admission under D-2026-0804-16 and MRX1000-W45-SELECT-2026-08-12; no numerical cap or elapsed-time gate applies.',
...
batch.decision_authority.wave45_selection_decision_id = 'MRX1000-W45-SELECT-2026-08-12';
batch.decision_authority.wave45_selection_decision_path = decisionRelativePath;
batch.decision_authority.wave45_selection_decision_sha256 = sha256(decisionBytes);
