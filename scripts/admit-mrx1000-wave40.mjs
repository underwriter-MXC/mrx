...
const primaryKeyword = "How Will I Know if I'm Receiving a Fair Valuation for My Mineral Rights?";
const keyword = primaryKeyword;
const programRowId = 'MRX1000-0120';
const selectionRank = 120;
...
const decisionRelativePath = 'docs/governance/mrx1000-wave40-selection-decision-2026-08-12.md';
const creativeManifestRelativePath =
  'artifacts/mrx1000-wave40-creative-qa/understanding-fair-valuation-key-factors-for-assessing-your-mineral-rights-worth/creative-manifest.json';
...
async function writeReviewPlaceholder(relativePath, capability, now) {
  ...
  const artifact = {
    artifact_type: 'mrx1000_wave40_review_placeholder',
...
const retrofitRow = {
  ...
  inline: {
    ...
    visual_variant: 'wave40-distinct-generated-six-factor-valuation-symmetry-audit',
...
const batchRow = {
  ...
  risk_citation_remediation: [
    'The planning-only canonical row was developed into an original valuation-fairness symmetry audit. It tests consistent treatment of favorable and unfavorable evidence across interest identity, production and payments, commodity assumptions, development evidence, uncertainty, and transaction scope, then supplies a twelve-field audit record without importing factory body text.',
    'Continuous quality-gated admission under D-2026-0804-16 and MRX1000-W40-SELECT-2026-08-12; no numerical cap or elapsed-time gate applies.',
...
batch.decision_authority.wave40_selection_decision_id = 'MRX1000-W40-SELECT-2026-08-12';
batch.decision_authority.wave40_selection_decision_path = decisionRelativePath;
batch.decision_authority.wave40_selection_decision_sha256 = sha256(decisionBytes);
