...
const primaryKeyword = 'What Steps Are Involved in Getting a No-Obligation Review of My Mineral Rights?';
const keyword = primaryKeyword;
const programRowId = 'MRX1000-0132';
const selectionRank = 132;
...
const decisionRelativePath = 'docs/governance/mrx1000-wave52-selection-decision-2026-08-12.md';
const creativeManifestRelativePath =
  `artifacts/mrx1000-wave52-creative-qa/${slug}/creative-manifest.json`;
...
async function writeReviewPlaceholder(relativePath, capability, now) {
  ...
  const artifact = {
    artifact_type: 'mrx1000_wave52_review_placeholder',
...
const retrofitRow = {
  ...
  inline: {
    ...
    visual_variant: 'wave52-distinct-generated-seven-stage-private-booking-path',
...
const batchRow = {
  ...
  risk_citation_remediation: [
    'The planning-only canonical row was developed into an original current-booking transaction guide. It covers the private assistant, timezone, timing window, live-slot selection, appointment details, separate communication choices, booked-versus-not-booked states, and failure recovery without importing factory body text or duplicating the broader review-request, call-preparation, fee-boundary, or substantive review-process guides.',
    'Continuous quality-gated admission under D-2026-0804-16 and MRX1000-W52-SELECT-2026-08-12; no numerical cap or elapsed-time gate applies.',
...
batch.decision_authority.wave52_selection_decision_id = 'MRX1000-W52-SELECT-2026-08-12';
batch.decision_authority.wave52_selection_decision_path = decisionRelativePath;
batch.decision_authority.wave52_selection_decision_sha256 = sha256(decisionBytes);
