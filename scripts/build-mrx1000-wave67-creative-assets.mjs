...
const inlineFilename = 'one-contact-shared-information';
const paths = {
  heroSource: join(root, `artifacts/mrx1000-wave67-creative-sources/${slug}-hero-base.png`),
  inlineSource: join(root, `artifacts/mrx1000-wave67-creative-sources/${slug}-inline-base.png`),
  ...
  qa: join(root, `artifacts/mrx1000-wave67-creative-qa/${slug}`),
};

const generationPrompts = {
  hero: 'Premium documentary photograph of three adult family members from two generations calmly designating one administrative point person at a dining table on the right, with a blank notebook, pen, face-down phone, natural window light, and a clean deep-navy exact-title field on the left; no conflict theatrics, handshakes, cash, buyer branding, fake forms, maps, extra readable words, account numbers, dollar figures, dates, signatures, private information, logos, authority conclusions, title conclusions, value conclusions, legal conclusions, recommendations, offers, guarantees, or success claims.',
  inline:
    'Compositionally distinct people-free overhead communication-routing workspace with a face-down phone, closed navy notebook, four unaddressed blank envelopes, four blank color tabs, and a clean navy lower exact-phrase field; no people, maps, arrows, diagrams, screens, cash, buyer branding, fake forms, extra readable words, account numbers, dollar figures, dates, signatures, private information, logos, authority conclusions, title conclusions, value conclusions, legal conclusions, recommendations, offers, guarantees, or success claims.',
};
  ...
  return Buffer.from(`
    <svg width="1200" height="630" xmlns="http://www.w3.org/2000/svg">
      ...
      <text class="title" x="46" y="205">
        <tspan x="46" dy="0">How to Choose a Family</tspan>
        <tspan x="46" dy="66">Point Person for Mineral</tspan>
        <tspan x="46" dy="66">Rights Inquiries</tspan>
      </text>
    </svg>
  `);
}
  ...
  return Buffer.from(`
    <svg width="1200" height="675" xmlns="http://www.w3.org/2000/svg">
      ...
      <text class="keyword" x="600" y="558">
        <tspan x="600" dy="0">One Contact, Shared Information</tspan>
      </text>
    </svg>
  `);
}
...
async function main() {
  ...
  const tempDirectory = await mkdtemp(join(tmpdir(), 'mrx-wave67-ocr-'));
  try {
