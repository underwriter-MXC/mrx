...
const primaryKeyword = 'What Are Common Pitfalls I Should Avoid in Selling Mineral Rights?';
const keyword = primaryKeyword;
const programRowId = 'MRX1000-0117';
const selectionRank = 117;
...
const decisionRelativePath = 'docs/governance/mrx1000-wave37-selection-decision-2026-08-12.md';
const creativeManifestRelativePath =
  'artifacts/mrx1000-wave37-creative-qa/top-five-missteps-to-avoid-for-a-successful-mineral-rights-sale/creative-manifest.json';
...
async function writeReviewPlaceholder(relativePath, capability, now) {
  ...
  const artifact = {
    artifact_type: 'mrx1000_wave37_review_placeholder',
...
const retrofitRow = {
  ...
  inline: {
    ...
    visual_variant: 'wave37-distinct-generated-five-checkpoint-prevention-system',
...
const batchRow = {
  ...
  risk_citation_remediation: [
    'The planning-only canonical row was developed into an original five-error owner decision and recovery playbook that separates objectives, evidence readiness, comparable proposal review, professional handoffs, and controlled closing; each misstep has a prevention artifact, recovery action, stop rule, and source-aware limitation without importing factory body text.',
    'Continuous quality-gated admission under D-2026-0804-16 and MRX1000-W37-SELECT-2026-08-12; no numerical cap or elapsed-time gate applies.',
...
batch.decision_authority.wave37_selection_decision_id = 'MRX1000-W37-SELECT-2026-08-12';
batch.decision_authority.wave37_selection_decision_path = decisionRelativePath;
batch.decision_authority.wave37_selection_decision_sha256 = sha256(decisionBytes);
