...
const primaryKeyword = 'Mineral Rights Explained for Beginners';
const keyword = primaryKeyword;
const programRowId = 'MRX1000-0122';
const selectionRank = 122;
...
const decisionRelativePath = 'docs/governance/mrx1000-wave42-selection-decision-2026-08-12.md';
const creativeManifestRelativePath =
  'artifacts/mrx1000-wave42-creative-qa/understanding-mineral-rights-for-new-owners/creative-manifest.json';
...
async function writeReviewPlaceholder(relativePath, capability, now) {
  ...
  const artifact = {
    artifact_type: 'mrx1000_wave42_review_placeholder',
...
const retrofitRow = {
  ...
  inline: {
    ...
    visual_variant: 'wave42-distinct-generated-new-owner-first-30-days-control-record',
...
const batchRow = {
  ...
  risk_citation_remediation: [
    'The planning-only canonical row was developed into an original new-owner first-30-days control record. It separates source and county records, operational evidence, payor and tax evidence, and open professional questions without importing factory body text or making a title conclusion.',
    'Continuous quality-gated admission under D-2026-0804-16 and MRX1000-W42-SELECT-2026-08-12; no numerical cap or elapsed-time gate applies.',
...
batch.decision_authority.wave42_selection_decision_id = 'MRX1000-W42-SELECT-2026-08-12';
batch.decision_authority.wave42_selection_decision_path = decisionRelativePath;
batch.decision_authority.wave42_selection_decision_sha256 = sha256(decisionBytes);
