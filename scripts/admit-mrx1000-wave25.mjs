...
const primaryKeyword = 'Factors Affecting Mineral Rights Value';
const keyword = primaryKeyword;
const programRowId = 'MRX1000-0183';
const selectionRank = 105;
...
const decisionRelativePath = 'docs/governance/mrx1000-wave25-selection-decision-2026-08-11.md';
const creativeManifestRelativePath =
  'artifacts/mrx1000-wave25-creative-qa/how-mineral-rights-valuation-affects-your-asset-decisions/creative-manifest.json';
...
async function writeReviewPlaceholder(relativePath, capability, now) {
  ...
  const artifact = {
    artifact_type: 'mrx1000_wave25_review_placeholder',
...
const retrofitRow = {
  ...
  inline: {
    ...
    visual_variant: 'wave25-distinct-generated-mineral-asset-decision-evidence-board',
...
const batchRow = {
  ...
  risk_citation_remediation: [
    'The planning-only canonical row was developed into an original valuation-to-decision framework that separates property facts, model assumptions, scenario outputs, confidence, option scope, and owner criteria; no factory body text was imported.',
    'Continuous quality-gated admission under D-2026-0804-16 and MRX1000-W25-SELECT-2026-08-11; no numerical cap or elapsed-time gate applies.',
...
batch.decision_authority.wave25_selection_decision_id = 'MRX1000-W25-SELECT-2026-08-11';
batch.decision_authority.wave25_selection_decision_path = decisionRelativePath;
batch.decision_authority.wave25_selection_decision_sha256 = sha256(decisionBytes);
