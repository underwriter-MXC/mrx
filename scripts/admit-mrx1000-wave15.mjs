...
const primaryKeyword = 'monthly royalty history valuation baseline';
const keyword = 'monthly royalty history worksheet';
const programRowId = 'MRX1000-0173';
const selectionRank = 95;
...
const decisionRelativePath = 'docs/governance/mrx1000-wave15-selection-decision-2026-08-11.md';
const creativeManifestRelativePath =
  'artifacts/mrx1000-wave15-creative-qa/converting-monthly-royalty-history-into-a-valuation-baseline/creative-manifest.json';
...
async function writeReviewPlaceholder(relativePath, capability, now) {
  ...
  const artifact = {
    artifact_type: 'mrx1000_wave15_review_placeholder',
...
const retrofitRow = {
  ...
  inline: {
    ...
    visual_variant: 'wave15-distinct-generated-monthly-royalty-workspace',
...
const batchRow = {
  ...
  risk_citation_remediation: [
    'The planning-only canonical row was developed into an original, evidence-bounded royalty-history guide; no factory body text was imported.',
    'Continuous quality-gated admission under D-2026-0804-16 and MRX1000-W15-SELECT-2026-08-11; no numerical cap or elapsed-time gate applies.',
