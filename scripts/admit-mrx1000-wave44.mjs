...
const primaryKeyword = 'How Can I Determine if My Mineral Rights Qualify for a Fair Assessment?';
const keyword = primaryKeyword;
const programRowId = 'MRX1000-0124';
const selectionRank = 124;
...
const decisionRelativePath = 'docs/governance/mrx1000-wave44-selection-decision-2026-08-12.md';
const creativeManifestRelativePath =
  `artifacts/mrx1000-wave44-creative-qa/${slug}/creative-manifest.json`;
...
async function writeReviewPlaceholder(relativePath, capability, now) {
  ...
  const artifact = {
    artifact_type: 'mrx1000_wave44_review_placeholder',
...
const retrofitRow = {
  ...
  inline: {
    ...
    visual_variant: 'wave44-distinct-generated-assessment-pathway-matrix',
...
const batchRow = {
  ...
  risk_citation_remediation: [
    'The planning-only canonical row was developed into an original assessment-fitness and pathway-selection guide. It aligns a stated decision, defined asset, available evidence, and fit-for-purpose method across five pathways and three bounded scope results without importing factory body text or equating qualification with ownership, value, eligibility, or transaction acceptance.',
    'Continuous quality-gated admission under D-2026-0804-16 and MRX1000-W44-SELECT-2026-08-12; no numerical cap or elapsed-time gate applies.',
...
batch.decision_authority.wave44_selection_decision_id = 'MRX1000-W44-SELECT-2026-08-12';
batch.decision_authority.wave44_selection_decision_path = decisionRelativePath;
batch.decision_authority.wave44_selection_decision_sha256 = sha256(decisionBytes);
