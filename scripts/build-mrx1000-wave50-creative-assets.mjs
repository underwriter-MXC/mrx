...
const title =
  'Understanding the Key Factors That Affect Your Mineral Rights Assessment Price';
const keyword = 'What Factors Influence the Price You Suggest for My Mineral Rights Assessment?';
const inlineFilename =
  'what-factors-influence-the-price-you-suggest-for-my-mineral-rights-assessment';
const paths = {
  heroSource: join(root, `artifacts/mrx1000-wave50-creative-sources/${slug}-hero-base.png`),
  inlineSource: join(root, `artifacts/mrx1000-wave50-creative-sources/${slug}-inline-base.png`),
  ...
  qa: join(root, `artifacts/mrx1000-wave50-creative-qa/${slug}`),
};

const generationPrompts = {
  hero:
    'No-people Texas assessment-price audit still life with survey map, abstract royalty statement, production-curve glass, acreage divider, pumpjack, mineral cores, and four review cards beside a deep-navy exact-title field; no extra readable words, numbers, prices, formulas, signatures, private information, logos, seals, ownership conclusions, value conclusions, legal conclusions, tax conclusions, offer claims, or success claims.',
  inline:
    'Compositionally distinct no-people six-stage assessment-price bridge showing interest scope, owner records, current production, conditional development, dated market assumptions, and transaction scope below a navy exact-question field; no extra readable words, numbers, prices, formulas, signatures, private information, logos, seals, ownership conclusions, value conclusions, legal conclusions, tax conclusions, offer claims, or success claims.',
};
...
function heroTypography() {
  return Buffer.from(`
    <svg width="1200" height="630" xmlns="http://www.w3.org/2000/svg">
      ...
      <style>
        .title { fill: #fffaf0; font-family: Georgia, 'Times New Roman', serif; font-size: 35px; font-weight: 700; letter-spacing: -0.55px; }
        .rule { fill: #d79a2b; }
      </style>
      ...
      <text class="title" x="46" y="197">
        <tspan x="46" dy="0">Understanding the Key</tspan>
        <tspan x="46" dy="48">Factors That Affect Your</tspan>
        <tspan x="46" dy="48">Mineral Rights</tspan>
        <tspan x="46" dy="48">Assessment Price</tspan>
      </text>
    </svg>
  `);
}
  ...
  return Buffer.from(`
    <svg width="1200" height="675" xmlns="http://www.w3.org/2000/svg">
      ...
      <text class="keyword" x="600" y="63">
        <tspan x="600" dy="0">What Factors Influence the</tspan>
        <tspan x="600" dy="47">Price You Suggest for My</tspan>
        <tspan x="600" dy="47">Mineral Rights Assessment?</tspan>
      </text>
    </svg>
  `);
}
...
async function main() {
  ...
  const tempDirectory = await mkdtemp(join(tmpdir(), 'mrx-wave50-ocr-'));
  try {
