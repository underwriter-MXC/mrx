...
const title =
  'Understanding the Factors Behind the Valuation of Your Texas Mineral Rights Explained';
const primaryKeyword = 'How Is the Value of My Texas Mineral Rights Determined and Assessed?';
const keyword = primaryKeyword;
const programRowId = 'MRX1000-0129';
const selectionRank = 129;
...
const decisionRelativePath = 'docs/governance/mrx1000-wave49-selection-decision-2026-08-12.md';
const creativeManifestRelativePath =
  `artifacts/mrx1000-wave49-creative-qa/${slug}/creative-manifest.json`;
...
async function writeReviewPlaceholder(relativePath, capability, now) {
  ...
  const artifact = {
    artifact_type: 'mrx1000_wave49_review_placeholder',
...
const retrofitRow = {
  ...
  inline: {
    ...
    visual_variant: 'wave49-distinct-generated-five-layer-texas-valuation-stack',
...
const batchRow = {
  ...
  risk_citation_remediation: [
    'The planning-only canonical row was developed into an original Texas valuation mechanics and evidence-confidence guide. It shows where interest quantity, matched owner cash flow, production and development evidence, market and forecast assumptions, method reconciliation, and transaction scope enter a conditional range, then grades evidence separately without importing factory body text or duplicating the process, factor-list, factor-to-range, or introductory value-driver guides.',
    'Continuous quality-gated admission under D-2026-0804-16 and MRX1000-W49-SELECT-2026-08-12; no numerical cap or elapsed-time gate applies.',
...
batch.decision_authority.wave49_selection_decision_id = 'MRX1000-W49-SELECT-2026-08-12';
batch.decision_authority.wave49_selection_decision_path = decisionRelativePath;
batch.decision_authority.wave49_selection_decision_sha256 = sha256(decisionBytes);
