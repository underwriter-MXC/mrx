...
const primaryKeyword = 'Navigating Mineral Rights Transactions Texas';
const keyword = primaryKeyword;
const programRowId = 'MRX1000-0127';
const selectionRank = 127;
...
const decisionRelativePath = 'docs/governance/mrx1000-wave47-selection-decision-2026-08-12.md';
const creativeManifestRelativePath =
  'artifacts/mrx1000-wave47-creative-qa/understanding-texas-mineral-rights-transactions-today/creative-manifest.json';
...
async function writeReviewPlaceholder(relativePath, capability, now) {
  ...
  const artifact = {
    artifact_type: 'mrx1000_wave47_review_placeholder',
...
const [articleBytes, decisionBytes, creativeBytes, batchBytes, retrofitBytes, ledgerBytes] =
  await Promise.all([
...
const retrofitRow = {
  ...
  inline: {
    ...
    visual_variant: 'wave47-distinct-generated-six-lane-texas-transaction-evidence-route',
...
const batchRow = {
  ...
  risk_citation_remediation: [
    'The planning-only canonical row was developed into an original Texas transaction-source routing guide that separates ownership and authority, asset and operating identity, payment history, directional economics, counterparty and proposal evidence, and document-closing-post-closing records. Every lane states the source limitation and professional handoff without importing factory body text or duplicating the existing Texas selling-process and seller-readiness guides.',
    'Continuous quality-gated admission under D-2026-0804-16 and MRX1000-W47-SELECT-2026-08-12; no numerical cap or elapsed-time gate applies.',
...
batch.decision_authority.wave47_selection_decision_id = 'MRX1000-W47-SELECT-2026-08-12';
batch.decision_authority.wave47_selection_decision_path = decisionRelativePath;
batch.decision_authority.wave47_selection_decision_sha256 = sha256(decisionBytes);
