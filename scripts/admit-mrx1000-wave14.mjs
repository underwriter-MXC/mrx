...
const decisionRelativePath = 'docs/governance/mrx1000-wave14-selection-decision-2026-08-11.md';
const creativeManifestRelativePath =
  'artifacts/mrx1000-wave14-creative-qa/comparable-mineral-sales-what-makes-a-transaction-relevant/creative-manifest.json';
...
async function writeReviewPlaceholder(relativePath, capability, now) {
  ...
  const artifact = {
    artifact_type: 'mrx1000_wave14_review_placeholder',
...
const retrofitRow = {
  ...
  inline: {
    ...
    visual_variant: 'wave14-distinct-generated-comparable-sale-workspace',
...
const batchRow = {
  ...
  risk_citation_remediation: [
    ...
    'Continuous quality-gated admission under D-2026-0804-16 and MRX1000-W14-SELECT-2026-08-11; no numerical cap or elapsed-time gate applies.',
...
batch.decision_authority.wave14_selection_decision_id = 'MRX1000-W14-SELECT-2026-08-11';
batch.decision_authority.wave14_selection_decision_path = decisionRelativePath;
batch.decision_authority.wave14_selection_decision_sha256 = sha256(decisionBytes);
