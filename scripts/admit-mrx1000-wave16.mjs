...
const primaryKeyword = 'curative title risk valuation adjustment';
const keyword = 'curative title risk worksheet';
const programRowId = 'MRX1000-0174';
const selectionRank = 96;
...
const decisionRelativePath = 'docs/governance/mrx1000-wave16-selection-decision-2026-08-11.md';
const creativeManifestRelativePath =
  'artifacts/mrx1000-wave16-creative-qa/curative-title-risk-as-a-valuation-adjustment/creative-manifest.json';
...
async function writeReviewPlaceholder(relativePath, capability, now) {
  ...
  const artifact = {
    artifact_type: 'mrx1000_wave16_review_placeholder',
...
const retrofitRow = {
  ...
  inline: {
    ...
    visual_variant: 'wave16-distinct-generated-chain-of-title-workspace',
...
const batchRow = {
  ...
  risk_citation_remediation: [
    'The planning-only canonical row was developed into an original, evidence-bounded curative-title-risk guide; no factory body text was imported.',
    'Continuous quality-gated admission under D-2026-0804-16 and MRX1000-W16-SELECT-2026-08-11; no numerical cap or elapsed-time gate applies.',
...
batch.decision_authority.wave16_selection_decision_id = 'MRX1000-W16-SELECT-2026-08-11';
batch.decision_authority.wave16_selection_decision_path = decisionRelativePath;
batch.decision_authority.wave16_selection_decision_sha256 = sha256(decisionBytes);
