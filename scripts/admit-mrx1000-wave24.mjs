...
const primaryKeyword = 'lease royalty rates mineral value';
const keyword = primaryKeyword;
const programRowId = 'MRX1000-0182';
const selectionRank = 104;
...
const decisionRelativePath = 'docs/governance/mrx1000-wave24-selection-decision-2026-08-11.md';
const creativeManifestRelativePath =
  'artifacts/mrx1000-wave24-creative-qa/how-lease-royalty-rates-influence-mineral-value/creative-manifest.json';
...
async function writeReviewPlaceholder(relativePath, capability, now) {
  ...
  const artifact = {
    artifact_type: 'mrx1000_wave24_review_placeholder',
...
const retrofitRow = {
  ...
  inline: {
    ...
    visual_variant: 'wave24-distinct-generated-lease-rate-sensitivity-board',
...
const batchRow = {
  ...
  risk_citation_remediation: [
    'The planning-only canonical row was developed into an original lease-rate sensitivity framework that separates the royalty fraction from ownership, participation, lease language, production, price, costs, timing, and risk; no factory body text was imported.',
    'Continuous quality-gated admission under D-2026-0804-16 and MRX1000-W24-SELECT-2026-08-11; no numerical cap or elapsed-time gate applies.',
...
batch.decision_authority.wave24_selection_decision_id = 'MRX1000-W24-SELECT-2026-08-11';
batch.decision_authority.wave24_selection_decision_path = decisionRelativePath;
batch.decision_authority.wave24_selection_decision_sha256 = sha256(decisionBytes);
