...
const title =
  'Uncovering Hidden Costs: What Every Mineral Rights Seller Should Know Before the Review';
const primaryKeyword = 'Are There Any Hidden Costs I Should Be Aware of During the Review?';
const keyword = primaryKeyword;
const programRowId = 'MRX1000-0118';
const selectionRank = 118;
...
const decisionRelativePath = 'docs/governance/mrx1000-wave38-selection-decision-2026-08-12.md';
const creativeManifestRelativePath =
  'artifacts/mrx1000-wave38-creative-qa/uncovering-hidden-costs-what-every-mineral-rights-seller-should-know-before-the-review/creative-manifest.json';
...
async function writeReviewPlaceholder(relativePath, capability, now) {
  ...
  const artifact = {
    artifact_type: 'mrx1000_wave38_review_placeholder',
...
const retrofitRow = {
  ...
  inline: {
    ...
    visual_variant: 'wave38-distinct-generated-five-part-cost-authorization-map',
...
const batchRow = {
  ...
  risk_citation_remediation: [
    'The planning-only canonical row was developed into an original pre-review cost-boundary and authorization guide. It separates the free MRX review, records, independently engaged professional services, later proposal adjustments and closing deductions, and tax or basis questions through a nine-field authorization register and explicit stop rules without importing factory body text.',
    'Continuous quality-gated admission under D-2026-0804-16 and MRX1000-W38-SELECT-2026-08-12; no numerical cap or elapsed-time gate applies.',
...
batch.decision_authority.wave38_selection_decision_id = 'MRX1000-W38-SELECT-2026-08-12';
batch.decision_authority.wave38_selection_decision_path = decisionRelativePath;
batch.decision_authority.wave38_selection_decision_sha256 = sha256(decisionBytes);
