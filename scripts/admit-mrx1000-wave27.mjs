...
const programRowId = 'MRX1000-0185';
const selectionRank = 107;
...
const decisionRelativePath = 'docs/governance/mrx1000-wave27-selection-decision-2026-08-12.md';
const creativeManifestRelativePath =
  'artifacts/mrx1000-wave27-creative-qa/how-much-are-mineral-rights-worth-checklist-without-obligation/creative-manifest.json';
...
async function writeReviewPlaceholder(relativePath, capability, now) {
  ...
  const artifact = {
    artifact_type: 'mrx1000_wave27_review_placeholder',
...
const retrofitRow = {
  ...
  inline: {
    ...
    visual_variant: 'wave27-distinct-generated-no-obligation-choice-pathway',
...
batch.decision_authority.wave27_selection_decision_id = 'MRX1000-W27-SELECT-2026-08-12';
batch.decision_authority.wave27_selection_decision_path = decisionRelativePath;
batch.decision_authority.wave27_selection_decision_sha256 = sha256(decisionBytes);
