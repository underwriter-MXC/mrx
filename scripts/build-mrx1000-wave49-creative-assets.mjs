...
const title =
  'Understanding the Factors Behind the Valuation of Your Texas Mineral Rights Explained';
const keyword = 'How Is the Value of My Texas Mineral Rights Determined and Assessed?';
const inlineFilename =
  'how-is-the-value-of-my-texas-mineral-rights-determined-and-assessed';
const paths = {
  heroSource: join(root, `artifacts/mrx1000-wave49-creative-sources/${slug}-hero-base.png`),
  inlineSource: join(root, `artifacts/mrx1000-wave49-creative-sources/${slug}-inline-base.png`),
  ...
  qa: join(root, `artifacts/mrx1000-wave49-creative-qa/${slug}`),
};

const generationPrompts = {
  hero:
    'No-people Texas valuation-mechanics still life with survey map, abstract royalty statement, production-curve glass, acreage divider, pumpjack, mineral cores, and contract folder beside a deep-navy exact-title field; no extra readable words, numbers, prices, formulas, signatures, private information, logos, seals, ownership conclusions, value conclusions, legal conclusions, or tax conclusions.',
  inline:
    'Compositionally distinct no-people five-layer Texas valuation stack showing interest scope, matched cash flow, development, assumptions and sensitivity, and transaction scope below a navy exact-question field; no extra readable words, numbers, prices, formulas, signatures, private information, logos, seals, ownership conclusions, value conclusions, legal conclusions, or tax conclusions.',
};
...
function heroTypography() {
  return Buffer.from(`
    <svg width="1200" height="630" xmlns="http://www.w3.org/2000/svg">
      ...
      <style>
        .title { fill: #fffaf0; font-family: Georgia, 'Times New Roman', serif; font-size: 36px; font-weight: 700; letter-spacing: -0.55px; }
        .rule { fill: #d79a2b; }
      </style>
      <rect x="0" y="0" width="592" height="630" fill="url(#navy)" />
      <rect class="rule" x="46" y="131" width="82" height="5" rx="2.5" />
      <text class="title" x="46" y="197">
        <tspan x="46" dy="0">Understanding the Factors</tspan>
        <tspan x="46" dy="48">Behind the Valuation of</tspan>
        <tspan x="46" dy="48">Your Texas Mineral Rights</tspan>
        <tspan x="46" dy="48">Explained</tspan>
      </text>
    </svg>
  `);
}
...
function inlineTypography() {
  return Buffer.from(`
    <svg width="1200" height="675" xmlns="http://www.w3.org/2000/svg">
      ...
      <style>
        .keyword { fill: #fffaf0; font-family: Georgia, 'Times New Roman', serif; font-size: 39px; font-weight: 700; text-anchor: middle; letter-spacing: -0.4px; }
        .rule { fill: #d79a2b; }
      </style>
      <rect x="0" y="0" width="1200" height="200" fill="url(#navy)" />
      <rect class="rule" x="0" y="196" width="1200" height="4" />
      <text class="keyword" x="600" y="63">
        <tspan x="600" dy="0">How Is the Value of My</tspan>
        <tspan x="600" dy="47">Texas Mineral Rights</tspan>
        <tspan x="600" dy="47">Determined and Assessed?</tspan>
      </text>
    </svg>
  `);
}
...
async function main() {
  ...
  const tempDirectory = await mkdtemp(join(tmpdir(), 'mrx-wave49-ocr-'));
  try {
