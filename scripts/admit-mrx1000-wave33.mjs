...
const decisionRelativePath = 'docs/governance/mrx1000-wave33-selection-decision-2026-08-12.md';
const creativeManifestRelativePath =
  'artifacts/mrx1000-wave33-creative-qa/selling-mineral-rights-valuation-factors-step-by-step/creative-manifest.json';
...
async function writeReviewPlaceholder(relativePath, capability, now) {
  ...
  const artifact = {
    artifact_type: 'mrx1000_wave33_review_placeholder',
...
const retrofitRow = {
  ...
  inline: {
    ...
    visual_variant: 'wave33-distinct-generated-six-stage-valuation-workflow',
...
const batchRow = {
  ...
  risk_citation_remediation: [
    'The planning-only canonical row was developed into an original nationwide step-by-step valuation workflow that fixes the review question and interest scope, grades and normalizes evidence, separates producing cash flow from undeveloped scenarios, records bounded assumptions, reconciles complete written terms, and freezes a versioned decision file with stop and reset rules; no factory body text was imported.',
    'Continuous quality-gated admission under D-2026-0804-16 and MRX1000-W33-SELECT-2026-08-12; no numerical cap or elapsed-time gate applies.',
...
batch.decision_authority.wave33_selection_decision_id = 'MRX1000-W33-SELECT-2026-08-12';
batch.decision_authority.wave33_selection_decision_path = decisionRelativePath;
batch.decision_authority.wave33_selection_decision_sha256 = sha256(decisionBytes);
