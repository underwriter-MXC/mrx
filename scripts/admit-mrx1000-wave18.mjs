...
const decisionRelativePath = 'docs/governance/mrx1000-wave18-selection-decision-2026-08-11.md';
const creativeManifestRelativePath =
  'artifacts/mrx1000-wave18-creative-qa/depth-severances-and-formation-rights-in-mineral-valuation/creative-manifest.json';
...
async function writeReviewPlaceholder(relativePath, capability, now) {
  ...
  const artifact = {
    artifact_type: 'mrx1000_wave18_review_placeholder',
...
const retrofitRow = {
  ...
  inline: {
    ...
    visual_variant: 'wave18-distinct-generated-formation-rights-workspace',
...
const batchRow = {
  ...
  risk_citation_remediation: [
    'The planning-only canonical row was developed into an original, evidence-bounded depth-severance and formation-rights valuation guide; no factory body text was imported.',
    'Continuous quality-gated admission under D-2026-0804-16 and MRX1000-W18-SELECT-2026-08-11; no numerical cap or elapsed-time gate applies.',
...
batch.decision_authority.wave18_selection_decision_id = 'MRX1000-W18-SELECT-2026-08-11';
batch.decision_authority.wave18_selection_decision_path = decisionRelativePath;
batch.decision_authority.wave18_selection_decision_sha256 = sha256(decisionBytes);
