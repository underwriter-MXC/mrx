...
const inlineFilename = 'what-makes-a-mineral-rights-valuation-range-wider-or-narrower';
const paths = {
  heroSource: join(root, `artifacts/mrx1000-wave58-creative-sources/${slug}-hero-base.png`),
  inlineSource: join(root, `artifacts/mrx1000-wave58-creative-sources/${slug}-inline-base.png`),
  ...
  qa: join(root, `artifacts/mrx1000-wave58-creative-qa/${slug}`),
};

const generationPrompts = {
  hero: 'Calm documentary mineral-rights review workspace with two evidence stacks flanking one base-case file, subtle tract and production context, and a deep-navy exact-title field; no extra readable words, numbers, prices, percentages, dates, signatures, private information, logos, legal conclusions, ownership conclusions, value conclusions, buyer claims, or success claims.',
  inline:
    'Compositionally distinct overhead range-width audit with six separate unlabeled lanes for scope, evidence, producing cash flow, development, market inputs, and transaction terms feeding a centered navy exact-question card; no extra readable words, numbers, prices, percentages, dates, signatures, private information, logos, legal conclusions, ownership conclusions, value conclusions, buyer claims, or success claims.',
};
  ...
  return Buffer.from(`
    <svg width="1200" height="630" xmlns="http://www.w3.org/2000/svg">
      ...
      <text class="title" x="46" y="169">
        <tspan x="46" dy="0">Why Is My Mineral Rights</tspan>
        <tspan x="46" dy="58">Valuation Range</tspan>
        <tspan x="46" dy="58">So Wide?</tspan>
      </text>
    </svg>
  `);
}
  ...
  return Buffer.from(`
    <svg width="1200" height="675" xmlns="http://www.w3.org/2000/svg">
      ...
      <text class="keyword" x="600" y="292">
        <tspan x="600" dy="0">What Makes a Mineral Rights</tspan>
        <tspan x="600" dy="58">Valuation Range Wider</tspan>
        <tspan x="600" dy="58">or Narrower?</tspan>
      </text>
    </svg>
  `);
}
...
async function main() {
  ...
  const tempDirectory = await mkdtemp(join(tmpdir(), 'mrx-wave58-ocr-'));
  try {
