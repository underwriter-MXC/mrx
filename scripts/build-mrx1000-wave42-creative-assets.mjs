...
const keyword = 'Mineral Rights Explained for Beginners';
const inlineFilename = 'mineral-rights-explained-for-beginners';
const paths = {
  heroSource: join(root, `artifacts/mrx1000-wave42-creative-sources/${slug}-hero-base.png`),
  inlineSource: join(root, `artifacts/mrx1000-wave42-creative-sources/${slug}-inline-base.png`),
  ...
  qa: join(root, `artifacts/mrx1000-wave42-creative-qa/${slug}`),
};

const generationPrompts = {
  hero:
    'Photorealistic Texas mineral-rights guide and new owner organizing blank color-coded folders and a clean land map, with a title-safe navy field and no readable text, letters, numbers, logos, seals, signatures, private information, prices, legal conclusions, or ownership conclusions.',
  inline:
    'Compositionally distinct overhead first-30-days owner-control system with blank folders, clean Texas land-map silhouette, magnifying glass, pen, and blank cards, with a phrase-safe navy band and no readable text, letters, numbers, logos, seals, signatures, private information, prices, legal conclusions, or ownership conclusions.',
};
...
function heroTypography() {
  return Buffer.from(`
    <svg width="1200" height="630" xmlns="http://www.w3.org/2000/svg">
      <style>
        .title { fill: #fffaf0; font-family: Georgia, 'Times New Roman', serif; font-size: 48px; font-weight: 700; letter-spacing: -0.7px; }
        .rule { fill: #d79a2b; }
      </style>
      <rect class="rule" x="52" y="198" width="72" height="5" rx="2.5" />
      <text class="title" x="52" y="265">
        <tspan x="52" dy="0">Understanding</tspan>
        <tspan x="52" dy="57">Mineral Rights for</tspan>
        <tspan x="52" dy="57">New Owners</tspan>
      </text>
    </svg>
  `);
}
...
function inlineTypography() {
  return Buffer.from(`
    <svg width="1200" height="675" xmlns="http://www.w3.org/2000/svg">
      <style>
        .keyword { fill: #fffaf0; font-family: Georgia, 'Times New Roman', serif; font-size: 50px; font-weight: 700; text-anchor: middle; letter-spacing: -0.5px; }
        .rule { fill: #d79a2b; }
      </style>
      <rect class="rule" x="530" y="100" width="140" height="5" rx="2.5" />
      <text class="keyword" x="600" y="170">
        <tspan x="600" dy="0">Mineral Rights Explained</tspan>
        <tspan x="600" dy="60">for Beginners</tspan>
      </text>
    </svg>
  `);
}
...
async function main() {
  ...
  const tempDirectory = await mkdtemp(join(tmpdir(), 'mrx-wave42-ocr-'));
  try {
