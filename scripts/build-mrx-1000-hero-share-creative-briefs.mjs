...
async function main() {
  ...
  const requiredTruths = [
    ...
    verification.existing_public_asset_verified_count === 79,
    verification.asset_generated_count === 79 + verification.held_current_asset_preserved_count,
    verification.on_disk_count === 79 + verification.held_current_asset_preserved_count,
    verification.published_count === 79,
    verification.release_blocked_count === 921,
    verification.held_count === 49,
    verification.held_current_asset_observed_count === 49,
