...
async function main() {
  ...
  const requiredTruths = [
    ...
    verification.existing_public_asset_verified_count === 44,
    verification.asset_generated_count === 44 + verification.held_current_asset_preserved_count,
    verification.on_disk_count === 44 + verification.held_current_asset_preserved_count,
    verification.published_count === 44,
    verification.release_blocked_count === 956,
    verification.held_count === 84,
    verification.held_current_asset_observed_count === 84,
