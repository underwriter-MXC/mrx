...
async function main() {
  ...
  const requiredTruths = [
    ...
    verification.existing_public_asset_verified_count === 59,
    verification.asset_generated_count === 59 + verification.held_current_asset_preserved_count,
    verification.on_disk_count === 59 + verification.held_current_asset_preserved_count,
    verification.published_count === 59,
    verification.release_blocked_count === 941,
    verification.held_count === 69,
    verification.held_current_asset_observed_count === 69,
