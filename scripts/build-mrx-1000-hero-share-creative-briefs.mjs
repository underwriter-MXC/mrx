...
async function main() {
  ...
  const requiredTruths = [
    ...
    verification.existing_public_asset_verified_count === 89,
    verification.asset_generated_count === 89 + verification.held_current_asset_preserved_count,
    verification.on_disk_count === 89 + verification.held_current_asset_preserved_count,
    verification.published_count === 89,
    verification.release_blocked_count === 911,
    verification.held_count === 39,
    verification.held_current_asset_observed_count === 39,
