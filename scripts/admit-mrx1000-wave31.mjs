...
const decisionRelativePath = 'docs/governance/mrx1000-wave31-selection-decision-2026-08-12.md';
const creativeManifestRelativePath =
  'artifacts/mrx1000-wave31-creative-qa/selling-mineral-rights-timeline-in-2026/creative-manifest.json';
...
async function writeReviewPlaceholder(relativePath, capability, now) {
  ...
  const artifact = {
    artifact_type: 'mrx1000_wave31_review_placeholder',
...
const retrofitRow = {
  ...
  inline: {
    ...
    visual_variant: 'wave31-distinct-generated-dependency-milestone-path',
...
const batchRow = {
  ...
  risk_citation_remediation: [
    'The planning-only canonical row was developed into an original nationwide dependency-based timeline with owner, buyer, joint, and third-party lanes; parallel work, critical-path identification, dated milestone evidence, closing-sequence handoffs, and explicit reforecast rules; no factory body text was imported.',
    'Continuous quality-gated admission under D-2026-0804-16 and MRX1000-W31-SELECT-2026-08-12; no numerical cap or elapsed-time gate applies.',
...
batch.decision_authority.wave31_selection_decision_id = 'MRX1000-W31-SELECT-2026-08-12';
batch.decision_authority.wave31_selection_decision_path = decisionRelativePath;
batch.decision_authority.wave31_selection_decision_sha256 = sha256(decisionBytes);
