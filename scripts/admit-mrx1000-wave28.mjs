...
const decisionRelativePath = 'docs/governance/mrx1000-wave28-selection-decision-2026-08-12.md';
const creativeManifestRelativePath =
  'artifacts/mrx1000-wave28-creative-qa/how-much-are-mineral-rights-worth-due-diligence-in-2026/creative-manifest.json';
...
async function writeReviewPlaceholder(relativePath, capability, now) {
  ...
  const artifact = {
    artifact_type: 'mrx1000_wave28_review_placeholder',
...
const retrofitRow = {
  ...
  inline: {
    ...
    visual_variant: 'wave28-distinct-generated-2026-input-freshness-chain',
...
const batchRow = {
  ...
  risk_citation_remediation: [
    'The planning-only canonical row was developed into an original 2026 input-freshness audit that separates effective dates, reporting lag, later corrections, current development evidence, current commodity assumptions, and a bounded change log; no factory body text was imported.',
    'Continuous quality-gated admission under D-2026-0804-16 and MRX1000-W28-SELECT-2026-08-12; no numerical cap or elapsed-time gate applies.',
...
batch.decision_authority.wave28_selection_decision_id = 'MRX1000-W28-SELECT-2026-08-12';
batch.decision_authority.wave28_selection_decision_path = decisionRelativePath;
batch.decision_authority.wave28_selection_decision_sha256 = sha256(decisionBytes);
