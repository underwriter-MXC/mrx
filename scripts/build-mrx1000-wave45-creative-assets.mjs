...
const keyword = 'Mineral Rights Appraisal Near Me';
const inlineFilename = 'mineral-rights-appraisal-near-me';
const paths = {
  heroSource: join(root, `artifacts/mrx1000-wave45-creative-sources/${slug}-hero-base.png`),
  inlineSource: join(root, `artifacts/mrx1000-wave45-creative-sources/${slug}-inline-base.png`),
  ...
  qa: join(root, `artifacts/mrx1000-wave45-creative-qa/${slug}`),
};

const generationPrompts = {
  hero:
    'Photorealistic Texas mineral owner coordinating a remote, location-aware review from a home office, with abstract county and parcel context, a left title-safe navy field, and no readable text, letters, numbers, logos, seals, signatures, private information, prices, formulas, offers, appraisal conclusions, legal conclusions, or ownership conclusions.',
  inline:
    'Compositionally distinct overhead jurisdiction-routing worktable with a blank Texas locator, abstract county-record folder, well-data tablet, lease, royalty statement, professional-referral card, and upper phrase-safe navy panel, with no readable text, letters, numbers, logos, seals, signatures, private information, prices, formulas, offers, appraisal conclusions, legal conclusions, or ownership conclusions.',
};
...
function heroTypography() {
  return Buffer.from(`
    <svg width="1200" height="630" xmlns="http://www.w3.org/2000/svg">
      <style>
        .title { fill: #fffaf0; font-family: Georgia, 'Times New Roman', serif; font-size: 43px; font-weight: 700; letter-spacing: -0.55px; }
        .rule { fill: #d79a2b; }
      </style>
      <rect class="rule" x="52" y="181" width="72" height="5" rx="2.5" />
      <text class="title" x="52" y="240">
        <tspan x="52" dy="0">Understanding Mineral</tspan>
        <tspan x="52" dy="54">Rights Valuation</tspan>
        <tspan x="52" dy="54">Near You</tspan>
      </text>
    </svg>
  `);
}
...
function inlineTypography() {
  return Buffer.from(`
    <svg width="1200" height="675" xmlns="http://www.w3.org/2000/svg">
      <style>
        .keyword { fill: #fffaf0; font-family: Georgia, 'Times New Roman', serif; font-size: 46px; font-weight: 700; text-anchor: middle; letter-spacing: -0.5px; }
        .rule { fill: #d79a2b; }
      </style>
      <rect class="rule" x="530" y="60" width="140" height="5" rx="2.5" />
      <text class="keyword" x="600" y="127">
        <tspan x="600" dy="0">Mineral Rights Appraisal</tspan>
        <tspan x="600" dy="57">Near Me</tspan>
      </text>
    </svg>
  `);
}
...
async function main() {
  ...
  const tempDirectory = await mkdtemp(join(tmpdir(), 'mrx-wave45-ocr-'));
  try {
