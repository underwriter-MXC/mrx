...
const primaryKeyword = 'selling mineral rights';
const keyword = primaryKeyword;
const programRowId = 'MRX1000-0112';
const selectionRank = 112;
...
const decisionRelativePath = 'docs/governance/mrx1000-wave32-selection-decision-2026-08-12.md';
const creativeManifestRelativePath =
  'artifacts/mrx1000-wave32-creative-qa/selling-mineral-rights-valuation-factors-in-2026/creative-manifest.json';
...
async function writeReviewPlaceholder(relativePath, capability, now) {
  ...
  const artifact = {
    artifact_type: 'mrx1000_wave32_review_placeholder',
...
const retrofitRow = {
  ...
  inline: {
    ...
    visual_variant: 'wave32-distinct-generated-three-ledger-factor-register',
...
const batchRow = {
  ...
  risk_citation_remediation: [
    'The planning-only canonical row was developed into an original nationwide seller-facing factor register that separates asset facts, forecast assumptions, and transaction terms; assigns source dates, confidence labels, scenario effects, verification owners, and reset triggers; and bridges ranges or offers factor by factor; no factory body text was imported.',
    'Continuous quality-gated admission under D-2026-0804-16 and MRX1000-W32-SELECT-2026-08-12; no numerical cap or elapsed-time gate applies.',
...
batch.decision_authority.wave32_selection_decision_id = 'MRX1000-W32-SELECT-2026-08-12';
batch.decision_authority.wave32_selection_decision_path = decisionRelativePath;
batch.decision_authority.wave32_selection_decision_sha256 = sha256(decisionBytes);
