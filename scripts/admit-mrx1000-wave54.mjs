...
const primaryKeyword = 'Understanding Texas Mineral Rights Worth';
const keyword = primaryKeyword;
const programRowId = 'MRX1000-0134';
const selectionRank = 134;
...
const decisionRelativePath = 'docs/governance/mrx1000-wave54-selection-decision-2026-08-13.md';
const creativeManifestRelativePath =
  `artifacts/mrx1000-wave54-creative-qa/${slug}/creative-manifest.json`;
...
async function writeReviewPlaceholder(relativePath, capability, now) {
  ...
  const artifact = {
    artifact_type: 'mrx1000_wave54_review_placeholder',
...
const retrofitRow = {
  ...
  inline: {
    ...
    visual_variant: 'wave54-distinct-generated-six-coordinate-value-question-compass',
...
const batchRow = {
  ...
  risk_citation_remediation: [
    'The planning-only canonical row was developed into an original Texas value-question decision guide. It freezes the decision, defined interest, effective date, evidence cutoff, requested output, and reset triggers; routes the question to four distinct output lanes; maps Texas evidence to its bounded purpose; and supplies a one-page question record without importing factory body text or duplicating the statewide worth primer, full valuation workflow, factor mechanics, source reconciliation, or pre-sale four-layer value bridge.',
    'Continuous quality-gated admission under D-2026-0804-16 and MRX1000-W54-SELECT-2026-08-13; no numerical cap or elapsed-time gate applies.',
...
batch.decision_authority.wave54_selection_decision_id = 'MRX1000-W54-SELECT-2026-08-13';
batch.decision_authority.wave54_selection_decision_path = decisionRelativePath;
batch.decision_authority.wave54_selection_decision_sha256 = sha256(decisionBytes);
