...
const primaryKeyword = 'Texas Mineral Rights Valuation Process';
const keyword = primaryKeyword;
const programRowId = 'MRX1000-0128';
const selectionRank = 128;
...
const decisionRelativePath = 'docs/governance/mrx1000-wave48-selection-decision-2026-08-12.md';
const creativeManifestRelativePath =
  'artifacts/mrx1000-wave48-creative-qa/understanding-texas-mineral-rights-valuation-process/creative-manifest.json';
...
async function writeReviewPlaceholder(relativePath, capability, now) {
  ...
  const artifact = {
    artifact_type: 'mrx1000_wave48_review_placeholder',
...
const retrofitRow = {
  ...
  inline: {
    ...
    visual_variant: 'wave48-distinct-generated-seven-stage-texas-valuation-process',
...
const batchRow = {
  ...
  risk_citation_remediation: [
    'The planning-only canonical row was developed into an original end-to-end Texas valuation-process audit trail. It locks the valuation question and date, asset scope, identifier chain, normalized production and payment evidence, economic assumptions, method fit, sensitivities, reconciliation, and final decision record without importing factory body text or duplicating the existing valuation-factor, pathway-selection, provider-routing, or reperformance guides.',
    'Continuous quality-gated admission under D-2026-0804-16 and MRX1000-W48-SELECT-2026-08-12; no numerical cap or elapsed-time gate applies.',
...
batch.decision_authority.wave48_selection_decision_id = 'MRX1000-W48-SELECT-2026-08-12';
batch.decision_authority.wave48_selection_decision_path = decisionRelativePath;
batch.decision_authority.wave48_selection_decision_sha256 = sha256(decisionBytes);
