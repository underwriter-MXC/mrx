...
const primaryKeyword = 'What to Know Before Selling Mineral Rights';
const keyword = primaryKeyword;
const programRowId = 'MRX1000-0133';
const selectionRank = 133;
...
const decisionRelativePath = 'docs/governance/mrx1000-wave53-selection-decision-2026-08-12.md';
const creativeManifestRelativePath =
  `artifacts/mrx1000-wave53-creative-qa/${slug}/creative-manifest.json`;
...
async function writeReviewPlaceholder(relativePath, capability, now) {
  ...
  const artifact = {
    artifact_type: 'mrx1000_wave53_review_placeholder',
...
const retrofitRow = {
  ...
  inline: {
    ...
    visual_variant: 'wave53-distinct-generated-four-lane-value-reconciliation-bridge',
...
const batchRow = {
  ...
  risk_citation_remediation: [
    'The planning-only canonical row was developed into an original pre-sale value-reconciliation guide. It separates the dated directional asset range, complete written proposal, provisional expected-owner-net layer, and owner decision threshold; labels inputs verified, estimated, assumed, or unresolved; and supplies a one-page decision record and stop conditions without importing factory body text or duplicating valuation reperformance, asset-path comparison, offer-fairness, or end-to-end selling-gate guides.',
    'Continuous quality-gated admission under D-2026-0804-16 and MRX1000-W53-SELECT-2026-08-12; no numerical cap or elapsed-time gate applies.',
...
batch.decision_authority.wave53_selection_decision_id = 'MRX1000-W53-SELECT-2026-08-12';
batch.decision_authority.wave53_selection_decision_path = decisionRelativePath;
batch.decision_authority.wave53_selection_decision_sha256 = sha256(decisionBytes);
