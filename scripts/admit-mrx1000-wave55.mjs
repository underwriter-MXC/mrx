...
const primaryKeyword = 'How Do I Know if My Mineral Rights Have Significant Value?';
const keyword = primaryKeyword;
const programRowId = 'MRX1000-0135';
const selectionRank = 135;
...
const decisionRelativePath = 'docs/governance/mrx1000-wave55-selection-decision-2026-08-13.md';
const creativeManifestRelativePath =
  `artifacts/mrx1000-wave55-creative-qa/${slug}/creative-manifest.json`;
...
async function writeReviewPlaceholder(relativePath, capability, now) {
  ...
  const artifact = {
    artifact_type: 'mrx1000_wave55_review_placeholder',
...
const retrofitRow = {
  ...
  inline: {
    ...
    visual_variant: 'wave55-distinct-generated-significance-screen-evidence-table',
...
const batchRow = {
  ...
  risk_citation_remediation: [
    'The planning-only canonical row was developed into an original mineral-rights significance screen. It tests asset identity, keeps observed economics, conditional development signals, written transaction evidence, and limitations in separate lanes, distinguishes missing from negative evidence, and routes the next step without importing factory body text or duplicating the value primer, factor map, evidence checklist, Texas value-question record, or pre-sale reconciliation.',
    'Continuous quality-gated admission under D-2026-0804-16 and MRX1000-W55-SELECT-2026-08-13; no numerical cap or elapsed-time gate applies.',
...
batch.decision_authority.wave55_selection_decision_id = 'MRX1000-W55-SELECT-2026-08-13';
batch.decision_authority.wave55_selection_decision_path = decisionRelativePath;
batch.decision_authority.wave55_selection_decision_sha256 = sha256(decisionBytes);
