...
const decisionRelativePath = 'docs/governance/mrx1000-wave26-selection-decision-2026-08-12.md';
const creativeManifestRelativePath =
  'artifacts/mrx1000-wave26-creative-qa/how-much-are-mineral-rights-worth-checklist-for-mineral-owners/creative-manifest.json';
...
async function writeReviewPlaceholder(relativePath, capability, now) {
  ...
  const artifact = {
    artifact_type: 'mrx1000_wave26_review_placeholder',
...
const retrofitRow = {
  ...
  inline: {
    ...
    visual_variant: 'wave26-distinct-generated-mineral-value-evidence-checklist',
...
const batchRow = {
  ...
  risk_citation_remediation: [
    ...
    'Continuous quality-gated admission under D-2026-0804-16 and MRX1000-W26-SELECT-2026-08-12; no numerical cap or elapsed-time gate applies.',
...
batch.decision_authority.wave26_selection_decision_id = 'MRX1000-W26-SELECT-2026-08-12';
batch.decision_authority.wave26_selection_decision_path = decisionRelativePath;
batch.decision_authority.wave26_selection_decision_sha256 = sha256(decisionBytes);
