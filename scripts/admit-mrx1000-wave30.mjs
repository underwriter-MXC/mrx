...
const decisionRelativePath = 'docs/governance/mrx1000-wave30-selection-decision-2026-08-12.md';
const creativeManifestRelativePath =
  'artifacts/mrx1000-wave30-creative-qa/selling-mineral-rights-selling-process-for-mineral-owners/creative-manifest.json';
...
async function writeReviewPlaceholder(relativePath, capability, now) {
  ...
  const artifact = {
    artifact_type: 'mrx1000_wave30_review_placeholder',
...
const retrofitRow = {
  ...
  inline: {
    ...
    visual_variant: 'wave30-distinct-generated-seller-control-handoff-map',
...
const batchRow = {
  ...
  risk_citation_remediation: [
    'The planning-only canonical row was developed into an original nationwide seller-control file with explicit scope, written-proposal, diligence, final-document, payment-security, closing, recording, and post-closing handoff gates; no factory body text was imported.',
    'Continuous quality-gated admission under D-2026-0804-16 and MRX1000-W30-SELECT-2026-08-12; no numerical cap or elapsed-time gate applies.',
...
batch.decision_authority.wave30_selection_decision_id = 'MRX1000-W30-SELECT-2026-08-12';
batch.decision_authority.wave30_selection_decision_path = decisionRelativePath;
batch.decision_authority.wave30_selection_decision_sha256 = sha256(decisionBytes);
