...
process.env.MRX_ARTICLE_KEYWORD = 'Texas RRC Oil Proration query retrieval';
process.env.MRX_HERO_FILENAME = 'texas-rrc-oil-proration-query-retrieval-provenance-worksheet';
process.env.MRX_INLINE_FILENAME = 'texas-rrc-oil-proration-query-retrieval';
process.env.MRX_HERO_LINES_JSON = JSON.stringify([
  'Texas RRC Oil Proration',
  'Query Retrieval',
