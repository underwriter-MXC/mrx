...
const primaryKeyword = 'Free Mineral Rights Valuation Review';
const keyword = primaryKeyword;
const programRowId = 'MRX1000-0181';
const selectionRank = 103;
...
const decisionRelativePath = 'docs/governance/mrx1000-wave23-selection-decision-2026-08-11.md';
const creativeManifestRelativePath =
  'artifacts/mrx1000-wave23-creative-qa/get-a-free-mineral-rights-valuation-review-today/creative-manifest.json';
...
async function writeReviewPlaceholder(relativePath, capability, now) {
  ...
  const artifact = {
    artifact_type: 'mrx1000_wave23_review_placeholder',
...
const retrofitRow = {
  ...
  inline: {
    ...
    visual_variant: 'wave23-distinct-generated-evidence-to-output-wall',
...
const batchRow = {
  ...
  risk_citation_remediation: [
    'The planning-only canonical row was developed into an original evidence-to-output framework for a free directional valuation review; it separates verified evidence, owner-provided statements, calculations, assumptions, conflicts, and missing inputs, and no factory body text was imported.',
    'Continuous quality-gated admission under D-2026-0804-16 and MRX1000-W23-SELECT-2026-08-11; no numerical cap or elapsed-time gate applies.',
...
batch.decision_authority.wave23_selection_decision_id = 'MRX1000-W23-SELECT-2026-08-11';
batch.decision_authority.wave23_selection_decision_path = decisionRelativePath;
batch.decision_authority.wave23_selection_decision_sha256 = sha256(decisionBytes);
