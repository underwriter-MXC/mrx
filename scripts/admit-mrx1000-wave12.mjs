...
const slug = 'acreage-contiguity-and-its-role-in-development-potential';
...
const programRowId = 'MRX1000-0170';
const selectionRank = 92;
...
const decisionRelativePath = 'docs/governance/mrx1000-wave12-selection-decision-2026-08-11.md';
const creativeManifestRelativePath =
  'artifacts/mrx1000-wave12-creative-qa/acreage-contiguity-and-its-role-in-development-potential/creative-manifest.json';
...
async function writeReviewPlaceholder(relativePath, capability, now) {
  ...
  const artifact = {
    artifact_type: 'mrx1000_wave12_review_placeholder',
...
const retrofitRow = {
  ...
  inline: {
    ...
    visual_variant: 'wave12-distinct-generated-terrain-model',
...
const batchRow = {
  ...
  risk_citation_remediation: [
    ...
    'Continuous quality-gated admission under D-2026-0804-16 and MRX1000-W12-SELECT-2026-08-11; no numerical cap or elapsed-time gate applies.',
...
batch.decision_authority.wave12_selection_decision_id = 'MRX1000-W12-SELECT-2026-08-11';
batch.decision_authority.wave12_selection_decision_path = decisionRelativePath;
batch.decision_authority.wave12_selection_decision_sha256 = sha256(decisionBytes);
