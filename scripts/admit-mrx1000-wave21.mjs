...
const primaryKeyword = 'existing wells future locations DCF';
const keyword = primaryKeyword;
const programRowId = 'MRX1000-0179';
const selectionRank = 101;
...
const decisionRelativePath = 'docs/governance/mrx1000-wave21-selection-decision-2026-08-11.md';
const creativeManifestRelativePath =
  'artifacts/mrx1000-wave21-creative-qa/existing-wells-vs-future-locations-in-a-dcf-model/creative-manifest.json';
...
async function writeReviewPlaceholder(relativePath, capability, now) {
  ...
  const artifact = {
    artifact_type: 'mrx1000_wave21_review_placeholder',
...
const retrofitRow = {
  ...
  inline: {
    ...
    visual_variant: 'wave21-distinct-generated-existing-vs-future-scenario-board',
...
const batchRow = {
  ...
  risk_citation_remediation: [
    'The planning-only canonical row was developed into an original, evidence-first separation of producing-well cash flow and conditional future-location scenarios; no factory body text was imported.',
    'Continuous quality-gated admission under D-2026-0804-16 and MRX1000-W21-SELECT-2026-08-11; no numerical cap or elapsed-time gate applies.',
...
batch.decision_authority.wave21_selection_decision_id = 'MRX1000-W21-SELECT-2026-08-11';
batch.decision_authority.wave21_selection_decision_path = decisionRelativePath;
batch.decision_authority.wave21_selection_decision_sha256 = sha256(decisionBytes);
