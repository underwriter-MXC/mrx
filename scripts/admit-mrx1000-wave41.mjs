...
const primaryKeyword = 'How Does the Market Demand Affect the Price I Can Expect for My Rights?';
const keyword = primaryKeyword;
const programRowId = 'MRX1000-0121';
const selectionRank = 121;
...
const decisionRelativePath = 'docs/governance/mrx1000-wave41-selection-decision-2026-08-12.md';
const creativeManifestRelativePath =
  'artifacts/mrx1000-wave41-creative-qa/understanding-market-demand-how-it-influences-the-value-of-your-mineral-rights/creative-manifest.json';
...
async function writeReviewPlaceholder(relativePath, capability, now) {
  ...
  const artifact = {
    artifact_type: 'mrx1000_wave41_review_placeholder',
...
const retrofitRow = {
  ...
  inline: {
    ...
    visual_variant: 'wave41-distinct-generated-three-layer-market-demand-transmission-audit',
...
const batchRow = {
  ...
  risk_citation_remediation: [
    'The planning-only canonical row was developed into an original three-layer market-demand transmission audit. It separates commodity-market demand, tract-connected development activity, and observable acquisition demand, then supplies a thirteen-field dated demand snapshot without importing factory body text.',
    'Continuous quality-gated admission under D-2026-0804-16 and MRX1000-W41-SELECT-2026-08-12; no numerical cap or elapsed-time gate applies.',
...
batch.decision_authority.wave41_selection_decision_id = 'MRX1000-W41-SELECT-2026-08-12';
batch.decision_authority.wave41_selection_decision_path = decisionRelativePath;
batch.decision_authority.wave41_selection_decision_sha256 = sha256(decisionBytes);
