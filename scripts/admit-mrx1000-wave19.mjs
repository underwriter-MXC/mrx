...
const decisionRelativePath = 'docs/governance/mrx1000-wave19-selection-decision-2026-08-11.md';
const creativeManifestRelativePath =
  'artifacts/mrx1000-wave19-creative-qa/discount-rates-in-mineral-rights-dcf-a-plain-language-guide/creative-manifest.json';
...
async function writeReviewPlaceholder(relativePath, capability, now) {
  ...
  const artifact = {
    artifact_type: 'mrx1000_wave19_review_placeholder',
...
const retrofitRow = {
  ...
  inline: {
    ...
    visual_variant: 'wave19-distinct-generated-present-value-workspace',
...
const batchRow = {
  ...
  risk_citation_remediation: [
    'The planning-only canonical row was developed into an original, evidence-bounded mineral-rights DCF discount-rate guide; no factory body text was imported.',
    'Continuous quality-gated admission under D-2026-0804-16 and MRX1000-W19-SELECT-2026-08-11; no numerical cap or elapsed-time gate applies.',
...
batch.decision_authority.wave19_selection_decision_id = 'MRX1000-W19-SELECT-2026-08-11';
batch.decision_authority.wave19_selection_decision_path = decisionRelativePath;
batch.decision_authority.wave19_selection_decision_sha256 = sha256(decisionBytes);
